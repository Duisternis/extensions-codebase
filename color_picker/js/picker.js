(() => {
            ...
            document.addEventListener("DOMContentLoaded", (function(i) {
                ...
                if (0 !== u) {
                    var d = function(t, e, i) {
                        ...
                        }(this, t), this.colors = [], this.hovering = !1, this.counter = 0, this.counter2 = 0, 
                        this.main_colors = [ "#f44336", "#e91e63", "#8a4af3", "#673ab7", "#3f51b5", "#2196f3", "#03a9f4", "#00bcd4", "#009688", "#4caf50", "#8bc34a", "#cddc39", "#ffeb3b", "#ffc107", "#ff9800", "#ff5722", "#795548", "#000000" ], 
                        this.ids = {
                            canvas: "color-inject-eye-dropper-canvas",
                            main: "color-inject-eye-dropper",
                            destroy: "colorPicker-destroy-all",
                            color_list: "colorPicker-color-list"
                        };
                    }), [ {
                        key: "start",
                        value: function(t) {
                            this.src = t, $(this.ids.main).length && $(this.ids.main).remove(), $("body").css("cursor", "wait"), 
                            $("body").append('\n            <div style="z-index:9999999999 !important" id="'.concat(this.ids.main, '">\n              <canvas id="').concat(this.ids.canvas, '" width="').concat(window.innerWidth, '" height="').concat(window.innerHeight, '"></canvas>\n            </div>\n          ')), 
                            this.setImage(), this.addListeners();
                        }
                    }, {
                        key: "getNewImage",
                        value: function() {
                        ...
                        key: "setImage",
                        value: function() {
                            var t = this, e = document.getElementById(this.ids.canvas), i = new Image;
                            i.addEventListener("load", (function() {
                                e.getContext("2d").drawImage(i, 0, 0, i.width, i.height, 0, 0, e.width, e.height), 
                                $("body").css("cursor", "crosshair"), t.startSampler(), $("#" + t.ids.canvas).colorSampler({
                                    onPreview: function(e) {
                                        $(".color-sampler-preview").css("border", "10px solid " + e), $(".color-sampler-preview input").val(t.rgb2hex(e)), 
                                        $(".color-sampler-preview input").css("background", e), 1 == t.isDark(e) ? $(".color-sampler-preview input").css("color", "#ffffff") : $(".color-sampler-preview input").css("color", "#000000");
                                    },
                                    onSelect: function(e) {
                                        chrome.runtime.sendMessage({
                                            ...
                                            i.optionsFromColorPicker.options.pickBehaviour.autoCopy && t.copyToClipboard(t.rgb2hex(e));
                                        }));
                                    }
                                });
                        ...
                        value: function() {
                            !function(t, e, i) {
                                var s, n, o = "color-sampler", r = ":" + o, a = !1, l = [], h = !1, c = 200, u = t();
                                function d(e, i) {
                                    this.canvas = t(e), this.options = i || {}, this.enabled = !0, this.context = e.getContext("2d"), 
                                    this.resize(), this.canvas.on("mousemove", this.onMousemove.bind(this)), this.canvas.on("mouseout", this.onMouseout.bind(this)), 
                                    this.canvas.on("click", this.onClick.bind(this));
                                }
                                t.expr[":"][o] = function(e) {
                                    return void 0 !== t(e).data(o);
                                }, d.prototype.resize = function() {
                                    var t = this.canvas;
                                    this.bounds = {
                                        left: parseInt(t.css("padding-left")) || 0,
                                        top: parseInt(t.css("padding-top")) || 0,
                                        right: t.width(),
                                        bottom: t.height()
                                    };
                                };
                                var p = Math.floor(480.5);
                                function f() {
                                    t(r).each((function() {
                                        t(this).data(o).resize();
                                    }));
                                }
                                function g() {
                                    h && (h = !1, s.removeClass("active"));
                                }
                                function m() {
                                    (u = u.filter(r)).each((function() {
                                        t(this).data(o).detect();
                                    })), 0 === u.length && (n = clearInterval(n));
                                }
                                d.prototype.onMousemove = function(e) {
                                    if (this.enabled) {
                                        var i = this.canvas, n = this.bounds, o = e.offsetX - n.left, r = e.offsetY - n.top;
                                        if (this.inRange = this.checkInRange(o, r), !this.inRange && (o < -5 || r < -5 || o >= n.right + 5 || r >= n.bottom + 5)) return void g();
                                        s.css({
                                            left: e.pageX + 5 + "px",
                                            top: e.pageY + 5 + "px"
                                        }), this.setupPreview(o, r), !h && (h = !0, s.addClass("active")), this.color = l[p].css("background-color"), 
                                        t.isFunction(this.options.onPreview) && this.options.onPreview.call(i, this.color), 
                                        this.canvas.trigger("sampler:preview", this.color);
                                    }
                                }, d.prototype.setupPreview = function(t, e) {
                                    for (var i = t - 15.5, s = e - 15.5, n = this.context.getImageData(i, s, 31, 31).data, o = 0, r = 0; o < n.length; o += 4, 
                                    ++r) {
                                        var a = parseInt(r / 31) + s, h = r % 31 + i;
                                        if (this.checkInRange(h, a)) {
                                            var c = Array.prototype.slice.call(n, o, o + 4);
                                            c[3] = Math.min(c[3] / 100, 1), c = "rgba(" + c.join(",") + ")", l[r].css("background-color", c);
                                        } else l[r].css("background-color", "white");
                                    }
                                }, d.prototype.checkInRange = function(t, e) {
                                    return t >= 0 && e >= 0 && t < this.bounds.right && e < this.bounds.bottom;
                                }, d.prototype.onMouseout = function() {
                                    g();
                                }, d.prototype.onClick = function(e) {
                                    this.color && this.enabled && this.inRange && (t.isFunction(this.options.onSelect) && this.options.onSelect.call(this.canvas, this.color), 
                                    this.canvas.trigger("sampler:select", this.color));
                                }, d.prototype.detect = function() {
                                    (this.canvas.width() != this.bounds.right || this.canvas.height() != this.bounds.bottom) && this.resize();
                                }, d.prototype.enable = function(t) {
                                    void 0 === t && (t = !0), this.enabled = t;
                                }, d.prototype.disable = function(t) {
                                    void 0 === t && (t = !0), this.enabled = !t, g();
                                };
                                var v = [ "enable", "disable", "resize" ];
                                t.fn.colorSampler = function(r, h) {
                                    var p, g = "string" == typeof r;
                                    return this.filter("canvas").each((function() {
                                        g ? -1 != t.inArray(r, v) && (p = t(this).data(o)) && p[r].apply(p, h) : (p = new d(this, h = r), 
                                        t(this).data(o, p), a || (a = !0, function() {
                                            s = t('<div style="z-index:99999999999 !important" class="color-sampler-preview"><input type="text" /></div>');
                                            var e = t("<table/>");
                                            s.append(e);
                                            for (var i = 0; i < 31; ++i) {
                                                for (var n = t("<tr>"), o = 0; o < 31; ++o) {
                                                    var r = t("<td></td>").attr("x", o).attr("y", i);
                                                    l.push(r), n.append(r);
                                                }
                                                e.append(n);
                                            }
                                            ...
                                            t(e).bind("resize", f);
                                        }))), u = u.add(this), c && !n && (n = setInterval(m, c)));
                                    })), this;
                                }, t.colorSamper = {}, t.colorSamper.setInterval = function(e) {
                                    e != c && t.isNumeric(e) && !(e < 0) && (c = e, n = clearInterval(n), c > 0 && (n = setInterval(m, c)));
                                };
                        ...
                        key: "isDark",
                        value: function(t) {
                            var e = t.replace(/^(rgb|rgba)\(/, "").replace(/\)$/, "").replace(/\s/g, "").split(",");
                            return 3 == e.length ? !(Math.round((299 * parseInt(e[0]) + 587 * parseInt(e[1]) + 114 * parseInt(e[2])) / 1e3) > 80) : 1 == e.length && !(Math.round((299 * parseInt((e = this.hexToRgb(e[0].replace("#", "")).split(","))[0]) + 587 * parseInt(e[1]) + 114 * parseInt(e[2])) / 1e3) > 80);
                        }
                    }, {
                        key: "rgb2hex",
                        value: function(t) {
                            var e = this.validColor(t);
                            return "" != e && (e = e.match(/^rgba?[\s+]?\([\s+]?(\d+)[\s+]?,[\s+]?(\d+)[\s+]?,[\s+]?(\d+)[\s+]?/i)) && 4 === e.length ? "#" + ("0" + parseInt(e[1], 10).toString(16)).slice(-2) + ("0" + parseInt(e[2], 10).toString(16)).slice(-2) + ("0" + parseInt(e[3], 10).toString(16)).slice(-2) : "";
                        }
                    }, {
                        key: "validColor",
                        value: function(t) {
                            var e = document.createElement("div");
                            return e.style.border = "1px solid " + t, e.style.borderColor;
                        }
                    }, {
                        key: "copyToClipboard",
                        value: function(t, e) {
                            var i = this;
                            1 == e ? this.handleCopy(t) : this.getConfig((function(e) {
                                (1 == e.auto_copy || null == e.auto_copy) && i.convertText(t, (function(t) {
                                    i.handleCopy(t);
                                }));
                            }));
                        }
                        ...
                        key: "restore",
                        value: function() {
                            $("body").css("overflow", "auto"), $("body").css("padding-right", 0), $("#cpg_wrapper").remove(), 
                        ...
                        key: "convertText",
                        value: function(t, e) {
                            this.getConfig((function(i) {
                                if (null != i.copy_format) switch (i.copy_format) {
                                  case "1":
                                    e(t);
                                    break;

                                  case "2":
                                    calculator.isHexColor(t) && e(t.replace(/#/g, ""));
                                    break;

                                  case "3":
                                    if (calculator.isHexColor(t)) {
                                        var s = calculator.hexToRgb2(t);
                                        s.r && e("rgba(".concat(s.r, ", ").concat(s.g, ", ").concat(s.b, ", 1)"));
                                    } else e(t);
                                    break;

                                  case "4":
                                    if (calculator.isHexColor(t)) {
                                        var n = calculator.hexToRgb2(t), o = calculator.rgb2hsv(n.r, n.g, n.b);
                                        e("hsv(".concat(o.h, ", ").concat(o.s, "%, ").concat(o.v, "%)"));
                                    } else e(t);
                                } else e(t);
                            }), (function() {
                                e(t);
                        ...
                        value: function(t) {
                            var e = $("<input />");
                            $("body").append(e), e.val(t.toLowerCase()).select(), document.execCommand("copy"), 
                            e.remove();
                        }
                    }, {
                        key: "getConfig",
                        value: function(t) {
                            window.chrome.storage.sync.get([ "config" ], (function(e) {
                                var i = {};
                                e.config && (i = e.config), t(i);
                            }));
                        }
                    }, {
                        key: "addListeners",
                        value: function() {
                            ...
                            $(window).keydown((function(e) {
                                27 == e.keyCode && (e.preventDefault(), t.destroy()), (e.metaKey || e.ctrlKey) && (187 == e.keyCode || 189 == e.keyCode) && e.preventDefault();
                        ...
                        key: "destroy",
                        value: function(t) {
                            $("body").css("cursor", "default"), $("#" + this.ids.canvas).off(), $("#" + this.ids.destroy).off(), 
                            $("#" + this.ids.main).remove(), $(".colorPicker-save-colors-bttn").off(), $(".color-sampler-preview").remove(), 
                            $(".colorPicker-color-box-remove").off(), $(".colorPicker-color-box-hex").off(), 
                            $(".colorPicker-color-box-rgb").off(), $(".colorPicker-main-wrapper").off(), $(window).unbind("scroll"), 
                            $(window).unbind("resize"), $(window).unbind("keydown"), $("body").css({
                                overflow: "auto",
                                cursor: "pointer"
                            });
                        }
                    ...
                    chrome.runtime.onMessage.addListener((function(t, e, i) {
                        var s = t.type, n = t.src, o = (t.tab, t.position);
                        switch (s) {
                          case "new-eye-dropper":
                            (new d).start(n);
                            break;

                          case "get-total-height":
                            i({
                                height: u
                            });
                            break;
                        ...
                        "use strict";
                        "object" == h(t) && "object" == h(t.exports) ? t.exports = e.document ? i(e, !0) : function(t) {
                            if (!t.document) throw Error("jQuery requires a window with a document");
                            return i(t);
                        } : i(e);
                    }("undefined" != typeof window ? window : l, (function(t, e) {
                        "use strict";
                        var i = [], o = t.document, a = Object.getPrototypeOf, l = i.slice, c = i.concat, u = i.push, d = i.indexOf, p = {}, f = p.toString, g = p.hasOwnProperty, m = g.toString, v = m.call(Object), _ = {}, b = function(t) {
                        ...
                        function x(t, e, i) {
                            var s, n = (e = e || o).createElement("script");
                            if (n.text = t, i) for (s in w) i[s] && (n[s] = i[s]);
                            e.head.appendChild(n).parentNode.removeChild(n);
                        }
                        function k(t) {
                            return null == t ? t + "" : "object" == h(t) || "function" == typeof t ? p[f.call(t)] || "object" : h(t);
                        }
                        ...
                        function T(t) {
                            ...
                            return !b(t) && !y(t) && ("array" === i || 0 === e || "number" == typeof e && e > 0 && e - 1 in t);
                        }
                        C.fn = C.prototype = {
                            jquery: "3.3.1",
                            constructor: C,
                            ...
                            for ("boolean" == typeof r && (c = r, r = arguments[a] || {}, a++), "object" == h(r) || b(r) || (r = {}), 
                            a === l && (r = this, a--); a < l; a++) if (null != (t = arguments[a])) for (e in t) i = r[e], 
                            r !== (s = t[e]) && (c && s && (C.isPlainObject(s) || (n = Array.isArray(s))) ? (n ? (n = !1, 
                            o = i && Array.isArray(i) ? i : []) : o = i && C.isPlainObject(i) ? i : {}, r[e] = C.extend(c, o, s)) : void 0 !== s && (r[e] = s));
                            return r;
                        }, C.extend({
                            ...
                            isPlainObject: function(t) {
                                var e, i;
                                return !(!t || "[object Object]" !== f.call(t) || (e = a(t)) && ("function" != typeof (i = g.call(e, "constructor") && e.constructor) || m.call(i) !== v));
                            },
                            ...
                            makeArray: function(t, e) {
                                var i = e || [];
                                return null != t && (T(Object(t)) ? C.merge(i, "string" == typeof t ? [ t ] : t) : u.call(i, t)), 
                                i;
                            },
                        ...
                        var I = function(t) {
                            var e, i, s, n, o, r, a, l, h, c, u, d, p, f, g, m, v, _, b, y = "sizzle" + 1 * new Date, w = t.document, x = 0, k = 0, C = rt(), D = rt(), T = rt(), I = function(t, e) {
                                return t === e && (u = !0), 0;
                            }, S = {}.hasOwnProperty, P = [], M = P.pop, A = P.push, E = P.push, H = P.slice, N = function(t, e) {
                                for (var i = 0, s = t.length; i < s; i++) if (t[i] === e) return i;
                                return -1;
                            }, O = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", z = "[\\x20\\t\\r\\n\\f]", W = "(?:\\\\.|[\\w-]|[^\0-\\xa0])+", L = "\\[" + z + "*(" + W + ")(?:" + z + "*([*^$|!~]?=)" + z + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + W + "))|)" + z + "*\\]", F = ":(" + W + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + L + ")*)|.*)\\)|)", R = RegExp(z + "+", "g"), j = RegExp("^" + z + "+|((?:^|[^\\\\])(?:\\\\.)*)" + z + "+$", "g"), q = RegExp("^" + z + "*," + z + "*"), B = RegExp("^" + z + "*([>+~]|" + z + ")" + z + "*"), Y = RegExp("=" + z + "*([^\\]'\"]*?)" + z + "*\\]", "g"), $ = RegExp(F), U = RegExp("^" + W + "$"), K = {
                                ID: RegExp("^#(" + W + ")"),
                                CLASS: RegExp("^\\.(" + W + ")"),
                                TAG: RegExp("^(" + W + "|[*])"),
                                ATTR: RegExp("^" + L),
                            ...
                            }, V = /^(?:input|select|textarea|button)$/i, X = /^h\d$/i, G = /^[^{]+\{\s*\[native \w/, Q = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, J = /[+~]/, Z = RegExp("\\\\([\\da-f]{1,6}" + z + "?|(" + z + ")|.)", "ig"), tt = function(t, e, i) {
                                var s = "0x" + e - 65536;
                            ...
                            try {
                                E.apply(P = H.call(w.childNodes), w.childNodes), P[w.childNodes.length].nodeType;
                            } catch (t) {
                                E = {
                            ...
                            function ot(t, e, s, n) {
                                ...
                                if (!n && ((e ? e.ownerDocument || e : w) !== p && d(e), e = e || p, g)) {
                                    if (11 !== x && (u = Q.exec(t))) if (o = u[1]) {
                                        ...
                                        } else if (_ && (h = _.getElementById(o)) && b(e, h) && h.id === o) return s.push(h), 
                                        s;
                                    } else {
                                        if (u[2]) return E.apply(s, e.getElementsByTagName(t)), s;
                                        if ((o = u[3]) && i.getElementsByClassName && e.getElementsByClassName) return E.apply(s, e.getElementsByClassName(o)), 
                                        s;
                                    }
                                    if (i.qsa && !T[t + " "] && (!m || !m.test(t))) {
                                        if (1 !== x) _ = e, v = t; else if ("object" !== e.nodeName.toLowerCase()) {
                                            ...
                                            a = (f = r(t)).length; a--; ) f[a] = "#" + c + " " + vt(f[a]);
                                            v = f.join(","), _ = J.test(t) && gt(e.parentNode) || e;
                                        }
                                        if (v) try {
                                            return E.apply(s, _.querySelectorAll(v)), s;
                                        } catch (t) {} finally {
                                            c === y && e.removeAttribute("id");
                                        }
                                    }
                                }
                                return l(t.replace(j, "$1"), e, s, n);
                            }
                            function rt() {
                                var t = [];
                            ...
                            function pt(t) {
                                return function(e) {
                                    return "form" in e ? e.parentNode && !1 === e.disabled ? "label" in e ? "label" in e.parentNode ? e.parentNode.disabled === t : e.disabled === t : e.isDisabled === t || !t !== e.isDisabled && nt(e) === t : e.disabled === t : "label" in e && e.disabled === t;
                                };
                            }
                            function ft(t) {
                            ...
                            for (e in i = ot.support = {}, o = ot.isXML = function(t) {
                                ...
                                g = !o(p), w !== p && (n = p.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", st, !1) : n.attachEvent && n.attachEvent("onunload", st)), 
                                i.attributes = lt((function(t) {
                                    ...
                                    t.querySelectorAll("[id~=" + y + "-]").length || m.push("~="), t.querySelectorAll(":checked").length || m.push(":checked"), 
                                    t.querySelectorAll("a#" + y + "+*").length || m.push(".#.+[+~]");
                                })), lt((function(t) {
                                    t.innerHTML = "<a href='' disabled='disabled'></a><select disabled='disabled'><option/></select>";
                                    var e = p.createElement("input");
                                    e.setAttribute("type", "hidden"), t.appendChild(e).setAttribute("name", "D"), t.querySelectorAll("[name=d]").length && m.push("name" + z + "*[*^$|!~]?="), 
                                ...
                                })), m = m.length && RegExp(m.join("|")), v = v.length && RegExp(v.join("|")), b = (e = G.test(f.compareDocumentPosition)) || G.test(f.contains) ? function(t, e) {
                                    ...
                                    return s || (1 & (s = (t.ownerDocument || t) === (e.ownerDocument || e) ? t.compareDocumentPosition(e) : 1) || !i.sortDetached && e.compareDocumentPosition(t) === s ? t === p || t.ownerDocument === w && b(w, t) ? -1 : e === p || e.ownerDocument === w && b(w, e) ? 1 : c ? N(c, t) - N(c, e) : 0 : 4 & s ? -1 : 1);
                                } : function(t, e) {
                                    if (t === e) return u = !0, 0;
                                ...
                                var n = s.attrHandle[e.toLowerCase()], o = n && S.call(s.attrHandle, e.toLowerCase()) ? n(t, e, !g) : void 0;
                                ...
                                preFilter: {
                                    ATTR: function(t) {
                                        return t[1] = t[1].replace(Z, tt), t[3] = (t[3] || t[4] || t[5] || "").replace(Z, tt), 
                                        "~=" === t[2] && (t[3] = " " + t[3] + " "), t.slice(0, 4);
                                    },
                                    CHILD: function(t) {
                                        return t[1] = t[1].toLowerCase(), "nth" === t[1].slice(0, 3) ? (t[3] || ot.error(t[0]), 
                                        t[4] = +(t[4] ? t[5] + (t[6] || 1) : 2 * ("even" === t[3] || "odd" === t[3])), t[5] = +(t[7] + t[8] || "odd" === t[3])) : t[3] && ot.error(t[0]), 
                                        t;
                                    },
                                    PSEUDO: function(t) {
                                        var e, i = !t[6] && t[2];
                                ...
                                filter: {
                                    ...
                                    CLASS: function(t) {
                                        var e = C[t + " "];
                                        return e || (e = RegExp("(^|" + z + ")" + t + "(" + z + "|$)"), C(t, (function(t) {
                                        ...
                                        return 1 === s && 0 === n ? function(t) {
                                            ...
                                            if (m) {
                                                ...
                                                if (f = [ r ? m.firstChild : m.lastChild ], r && _) {
                                                    for (b = (p = (h = (c = (u = (d = m)[y] || (d[y] = {}))[d.uniqueID] || (u[d.uniqueID] = {}))[t] || [])[0] === x && h[1]) && h[2], 
                                                    d = p && m.childNodes[p]; d = ++p && d && d[g] || (b = p = 0) || f.pop(); ) if (1 === d.nodeType && ++b && d === e) {
                                                        c[t] = [ x, p, b ];
                                                        break;
                                                    }
                                                } else if (_ && (b = p = (h = (c = (u = (d = e)[y] || (d[y] = {}))[d.uniqueID] || (u[d.uniqueID] = {}))[t] || [])[0] === x && h[1]), 
                                                !1 === b) for (;(d = ++p && d && d[g] || (b = p = 0) || f.pop()) && ((a ? d.nodeName.toLowerCase() !== v : 1 !== d.nodeType) || !++b || (_ && ((c = (u = d[y] || (d[y] = {}))[d.uniqueID] || (u[d.uniqueID] = {}))[t] = [ x, b ]), 
                                                d !== e)); ) ;
                                    ...
                                    PSEUDO: function(t, e) {
                                        ...
                                        return n[y] ? n(e) : n.length > 1 ? (i = [ t, t, "", e ], s.setFilters.hasOwnProperty(t.toLowerCase()) ? at((function(t, i) {
                                            for (var s, o = n(t, e), r = o.length; r--; ) t[s = N(t, o[r])] = !(i[s] = o[r]);
                                        })) : function(t) {
                                            return n(t, 0, i);
                                        }) : n;
                                    }
                                ...
                                pseudos: {
                                    not: at((function(t) {
                                        var e = [], i = [], s = a(t.replace(j, "$1"));
                                        return s[y] ? at((function(t, e, i, n) {
                            ...
                            function _t(t, e, i) {
                                ...
                                return e.first ? function(e, i, n) {
                                    ...
                                    } else for (;e = e[s]; ) if (1 === e.nodeType || r) if (c = (u = e[y] || (e[y] = {}))[e.uniqueID] || (u[e.uniqueID] = {}), 
                                    n && n === e.nodeName.toLowerCase()) e = e[s] || e; else {
                            ...
                            function yt(t, e, i, s, n) {
                                for (var o, r = [], a = 0, l = t.length, h = null != e; a < l; a++) (o = t[a]) && (i && !i(o, s, n) || (r.push(o), 
                                h && e.push(a)));
                                return r;
                            }
                            function wt(t, e, i, s, n, o) {
                                return s && !s[y] && (s = wt(s)), n && !n[y] && (n = wt(n, o)), at((function(o, r, a, l) {
                                    var h, c, u, d = [], p = [], f = r.length, g = o || function(t, e, i) {
                                        for (var s = 0, n = e.length; s < n; s++) ot(t, e[s], i);
                                        return i;
                                    }(e || "*", a.nodeType ? [ a ] : a, []), m = !t || !o && e ? g : yt(g, d, t, a, l), v = i ? n || (o ? t : f || s) ? [] : r : m;
                                    if (i && i(m, v, a, l), s) for (h = yt(v, p), s(h, [], a, l), c = h.length; c--; ) (u = h[c]) && (v[p[c]] = !(m[p[c]] = u));
                                    if (o) {
                                        if (n || t) {
                                            if (n) {
                                            ...
                                            for (c = v.length; c--; ) (u = v[c]) && (h = n ? N(o, u) : d[c]) > -1 && (o[h] = !(r[h] = u));
                                        }
                                    } else v = yt(v === r ? v.splice(f, v.length) : v), n ? n(null, r, v, l) : E.apply(r, v);
                                }));
                            }
                            function xt(t) {
                                for (var e, i, n, o = t.length, r = s.relative[t[0].type], a = r || s.relative[" "], l = r ? 1 : 0, c = _t((function(t) {
                                    ...
                                    return e = null, n;
                                } ]; l < o; l++) if (i = s.relative[t[l].type]) d = [ _t(bt(d), i) ]; else {
                                    if ((i = s.filter[t[l].type].apply(null, t[l].matches))[y]) {
                                        ...
                                        return wt(l > 1 && bt(d), l > 1 && vt(t.slice(0, l - 1).concat({
                                            value: " " === t[l - 2].type ? "*" : ""
                                        })).replace(j, "$1"), i, l < n && xt(t.slice(l, n)), n < o && xt(t = t.slice(n)), n < o && vt(t));
                                    }
                                    d.push(i);
                                }
                                return bt(d);
                            ...
                            return mt.prototype = s.filters = s.pseudos, s.setFilters = new mt, r = ot.tokenize = function(t, e) {
                                ...
                                for (a = t, l = [], h = s.preFilter; a; ) {
                                    for (r in (!i || (n = q.exec(a))) && (n && (a = a.slice(n[0].length) || a), l.push(o = [])), 
                                    i = !1, (n = B.exec(a)) && (i = n.shift(), o.push({
                                        value: i,
                                        type: n[0].replace(j, " ")
                                    }), a = a.slice(i.length)), s.filter) (n = K[r].exec(a)) && (!h[r] || (n = h[r](n))) && (i = n.shift(), 
                                    o.push({
                                        value: i,
                                        type: r,
                                        matches: n
                                ...
                                var i, n, o, a, l, c, u = [], f = [], m = T[t + " "];
                                if (!m) {
                                    for (e || (e = r(t)), c = e.length; c--; ) (m = xt(e[c]))[y] ? u.push(m) : f.push(m);
                                    (m = T(t, (i = f, o = (n = u).length > 0, a = i.length > 0, l = function(t, e, r, l, c) {
                                        var u, f, m, v = 0, _ = "0", b = t && [], y = [], w = h, k = t || a && s.find.TAG("*", c), C = x += null == w ? 1 : Math.random() || .1, D = k.length;
                                        for (c && (h = e === p || e || c); _ !== D && null != (u = k[_]); _++) {
                                            if (a && u) {
                                                for (f = 0, e || u.ownerDocument === p || (d(u), r = !g); m = i[f++]; ) if (m(u, e || p, r)) {
                                                    l.push(u);
                                                    break;
                                                }
                                                c && (x = C);
                                            }
                                            o && ((u = !m && u) && v--, t && b.push(u));
                                        }
                                        if (v += _, o && _ !== v) {
                                            for (f = 0; m = n[f++]; ) m(b, y, e, r);
                                            if (t) {
                                                if (v > 0) for (;_--; ) b[_] || y[_] || (y[_] = M.call(l));
                                                y = yt(y);
                                            }
                                            E.apply(l, y), c && !t && y.length > 0 && v + n.length > 1 && ot.uniqueSort(l);
                                        }
                                        return c && (x = C, h = w), b;
                                    }, o ? at(l) : l))).selector = t;
                                }
                                ...
                                if (i = i || [], 1 === p.length) {
                                    ...
                                    for (o = K.needsContext.test(t) ? 0 : l.length; o-- && (h = l[o], !s.relative[c = h.type]); ) if ((u = s.find[c]) && (n = u(h.matches[0].replace(Z, tt), J.test(l[0].type) && gt(e.parentNode) || e))) {
                                        if (l.splice(o, 1), !(t = n.length && vt(l))) return E.apply(i, n), i;
                                        break;
                                    }
                                }
                                return (d || a(t, p))(n, e, !g, i, !e || J.test(t) && gt(e.parentNode) || e), i;
                            }, i.sortStable = y.split("").sort(I).join("") === y, i.detectDuplicates = !!u, 
                            d(), i.sortDetached = lt((function(t) {
                        ...
                        C.find = I, (C.expr = I.selectors)[":"] = C.expr.pseudos, C.uniqueSort = C.unique = I.uniqueSort, 
                        C.text = I.getText, C.isXMLDoc = I.isXML, C.contains = I.contains, C.escapeSelector = I.escape;
                        ...
                        var E = /^<([a-z][^\/\0>:\x20\t\r\n\f]*)[\x20\t\r\n\f]*\/?>(?:<\/\1>|)$/i;
                        function H(t, e, i) {
                            return b(e) ? C.grep(t, (function(t, s) {
                        ...
                        C.filter = function(t, e, i) {
                            ...
                            is: function(t) {
                                return !!H(this, "string" == typeof t && M.test(t) ? C(t) : t || [], !1).length;
                            }
                        });
                        var N, O = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/;
                        (C.fn.init = function(t, e, i) {
                            ...
                            if (i = i || N, "string" == typeof t) {
                                ...
                                if (s[1]) {
                                    if (e = e instanceof C ? e[0] : e, C.merge(this, C.parseHTML(s[1], e && e.nodeType ? e.ownerDocument || e : o, !0)), 
                                    E.test(s[1]) && C.isPlainObject(e)) for (s in e) b(this[s]) ? this[s](e[s]) : this.attr(s, e[s]);
                                    return this;
                                }
                                return (n = o.getElementById(s[2])) && (this[0] = n, this.length = 1), this;
                            }
                            return t.nodeType ? (this[0] = t, this.length = 1, this) : b(t) ? void 0 !== i.ready ? i.ready(t) : t(C) : C.makeArray(t, this);
                        ...
                        C.fn.extend({
                            ...
                            closest: function(t, e) {
                                var i, s = 0, n = this.length, o = [], r = "string" != typeof t && C(t);
                                if (!M.test(t)) for (;s < n; s++) for (i = this[s]; i && i !== e; i = i.parentNode) if (i.nodeType < 11 && (r ? r.index(i) > -1 : 1 === i.nodeType && C.find.matchesSelector(i, t))) {
                                    o.push(i);
                                    break;
                                }
                            ...
                            C.fn[t] = function(i, s) {
                                var n = C.map(this, e, i);
                                return "Until" !== t.slice(-5) && (s = i), s && "string" == typeof s && (n = C.filter(s, n)), 
                                this.length > 1 && (W[t] || C.uniqueSort(n), z.test(t) && n.reverse()), this.pushStack(n);
                            };
                        }));
                        var F = /[^\x20\t\r\n\f]+/g;
                        function R(t) {
                        ...
                        function q(t, e, i, s) {
                            var n;
                            try {
                                t && b(n = t.promise) ? n.call(t).done(e).fail(i) : t && b(n = t.then) ? n.call(t, e, i) : e.apply(void 0, [ t ].slice(s));
                            } catch (t) {
                                i.apply(void 0, [ t ]);
                            }
                        }
                        C.Callbacks = function(t) {
                            t = "string" == typeof t ? (i = {}, C.each(t.match(F) || [], (function(t, e) {
                                i[e] = !0;
                            })), i) : C.extend({}, t);
                            var i, s, n, o, r, a = [], l = [], h = -1, c = function() {
                                for (r = r || t.once, o = s = !0; l.length; h = -1) for (n = l.shift(); ++h < a.length; ) !1 === a[h].apply(n[0], n[1]) && t.stopOnFalse && (h = a.length, 
                                n = !1);
                                t.memory || (n = !1), s = !1, r && (a = n ? [] : "");
                            }, u = {
                                add: function() {
                                    return a && (n && !s && (h = a.length - 1, l.push(n)), function e(i) {
                                        C.each(i, (function(i, s) {
                                            b(s) ? t.unique && u.has(s) || a.push(s) : s && s.length && "string" !== k(s) && e(s);
                                        }));
                                    }(arguments), n && !s && c()), this;
                                },
                                remove: function() {
                                    return C.each(arguments, (function(t, e) {
                                        for (var i; (i = C.inArray(e, a, i)) > -1; ) a.splice(i, 1), i <= h && h--;
                                    })), this;
                                },
                                has: function(t) {
                                ...
                                lock: function() {
                                    return r = l = [], n || s || (a = n = ""), this;
                                },
                                locked: function() {
                                    return !!r;
                                },
                                fireWith: function(t, e) {
                                    return r || (e = [ t, (e = e || []).slice ? e.slice() : e ], l.push(e), s || c()), 
                                    this;
                                },
                                fire: function() {
                            ...
                            Deferred: function(e) {
                                var i = [ [ "notify", "progress", C.Callbacks("memory"), C.Callbacks("memory"), 2 ], [ "resolve", "done", C.Callbacks("once memory"), C.Callbacks("once memory"), 0, "resolved" ], [ "reject", "fail", C.Callbacks("once memory"), C.Callbacks("once memory"), 1, "rejected" ] ], s = "pending", n = {
                                    state: function() {
                                        return s;
                                    },
                                    always: function() {
                                        ...
                                        return C.Deferred((function(e) {
                                            C.each(i, (function(i, s) {
                                                ...
                                                o[s[1]]((function() {
                                                    ...
                                                    t && b(t.promise) ? t.promise().progress(e.notify).done(e.resolve).fail(e.reject) : e[s[0] + "With"](this, n ? [ t ] : arguments);
                                                }));
                                            })), t = null;
                                        })).promise();
                                    },
                                    then: function(e, s, n) {
                                        ...
                                        function r(e, i, s, n) {
                                            return function() {
                                                var a = this, l = arguments, c = function() {
                                                    var t, c;
                                                    if (!(e < o)) {
                                                        if ((t = s.apply(a, l)) === i.promise()) throw TypeError("Thenable self-resolution");
                                                        b(c = t && ("object" == h(t) || "function" == typeof t) && t.then) ? n ? c.call(t, r(o, i, R, n), r(o, i, j, n)) : (o++, 
                                                        c.call(t, r(o, i, R, n), r(o, i, j, n), r(o, i, R, i.notifyWith))) : (s !== R && (a = void 0, 
                                                        l = [ t ]), (n || i.resolveWith)(a, l));
                                                    }
                                                }, u = n ? c : function() {
                                                    try {
                                                        c();
                                                    } catch (t) {
                                                        C.Deferred.exceptionHook && C.Deferred.exceptionHook(t, u.stackTrace), e + 1 >= o && (s !== j && (a = void 0, 
                                                        l = [ t ]), i.rejectWith(a, l));
                                                    }
                                                };
                                        ...
                                        return C.Deferred((function(t) {
                                            i[0][3].add(r(0, t, b(n) ? n : R, t.notifyWith)), i[1][3].add(r(0, t, b(e) ? e : R)), 
                                            i[2][3].add(r(0, t, b(s) ? s : j));
                                        })).promise();
                                    },
                                    promise: function(t) {
                                ...
                                return C.each(i, (function(t, e) {
                                    ...
                                    n[e[1]] = r.add, a && r.add((function() {
                                        s = a;
                                    }), i[3 - t][2].disable, i[3 - t][3].disable, i[0][2].lock, i[0][3].lock), r.add(e[3].fire), 
                                    o[e[0]] = function() {
                            ...
                            when: function(t) {
                                var e = arguments.length, i = e, s = Array(i), n = l.call(arguments), o = C.Deferred(), r = function(t) {
                                    return function(i) {
                                        s[t] = this, n[t] = arguments.length > 1 ? l.call(arguments) : i, --e || o.resolveWith(s, n);
                                    };
                                };
                                if (e <= 1 && (q(t, o.done(r(i)).resolve, o.reject, !e), "pending" === o.state() || b(n[i] && n[i].then))) return o.then();
                        ...
                        C.Deferred.exceptionHook = function(e, i) {
                            t.console && t.console.warn && e && B.test(e.name) && t.console.warn("jQuery.Deferred exception: " + e.message, e.stack, i);
                        ...
                        var Y = C.Deferred();
                        function $() {
                            o.removeEventListener("DOMContentLoaded", $), t.removeEventListener("load", $), 
                            C.ready();
                        }
                        C.fn.ready = function(t) {
                            ...
                            readyWait: 1,
                            ready: function(t) {
                                (!0 === t ? --C.readyWait : C.isReady) || (C.isReady = !0, !0 !== t && --C.readyWait > 0 || Y.resolveWith(o, [ C ]));
                            }
                        }), C.ready.then = Y.then, "complete" === o.readyState || "loading" !== o.readyState && !o.documentElement.doScroll ? t.setTimeout(C.ready) : (o.addEventListener("DOMContentLoaded", $), 
                        t.addEventListener("load", $));
                        var U = function t(e, i, s, n, o, r, a) {
                            var l = 0, h = e.length, c = null == s;
                            if ("object" === k(s)) for (l in o = !0, s) t(e, i, l, s[l], !0, r, a); else if (void 0 !== n && (o = !0, 
                            b(n) || (a = !0), c && (a ? (i.call(e, n), i = null) : (c = i, i = function(t, e, i) {
                                return c.call(C(t), i);
                        ...
                        function G(t) {
                            return t.replace(K, "ms-").replace(V, X);
                        }
                        var Q = function(t) {
                        ...
                        J.uid = 1, J.prototype = {
                            ...
                            remove: function(t, e) {
                                ...
                                if (void 0 !== s) {
                                    if (void 0 !== e) for ((i = (e = Array.isArray(e) ? e.map(G) : (e = G(e)) in s ? [ e ] : e.match(F) || []).length); i--; ) delete s[e[i]];
                        ...
                        var Z = new J, tt = new J, et = /^(?:\{[\w\W]*\}|\[[\w\W]*\])$/, it = /[A-Z]/g;
                        function st(t, e, i) {
                            var s, n;
                            if (void 0 === i && 1 === t.nodeType) if (s = "data-" + e.replace(it, "-$&").toLowerCase(), 
                        ...
                        C.extend({
                            ...
                            data: function(t, e) {
                                ...
                                if (void 0 === t) {
                                    if (this.length && (n = tt.get(o), 1 === o.nodeType && !Z.get(o, "hasDataAttrs"))) {
                                        for (i = r.length; i--; ) r[i] && 0 === (s = r[i].name).indexOf("data-") && st(o, s = G(s.slice(5)), n[s]);
                                        Z.set(o, "hasDataAttrs", !0);
                                    }
                                    return n;
                                }
                                return "object" == h(t) ? this.each((function() {
                                    tt.set(this, t);
                                })) : U(this, (function(e) {
                                    var i;
                                    if (o && void 0 === e) {
                                        if (void 0 !== (i = tt.get(o, t)) || void 0 !== (i = st(o, t))) return i;
                            ...
                            queue: function(t, e, i) {
                                var s;
                                if (t) return e = (e || "fx") + "queue", s = Z.get(t, e), i && (!s || Array.isArray(i) ? s = Z.access(t, e, C.makeArray(i)) : s.push(i)), 
                                s || [];
                            },
                            dequeue: function(t, e) {
                                var i = C.queue(t, e = e || "fx"), s = i.length, n = i.shift(), o = C._queueHooks(t, e);
                                "inprogress" === n && (n = i.shift(), s--), n && ("fx" === e && i.unshift("inprogress"), 
                            ...
                            promise: function(t, e) {
                                var i, s = 1, n = C.Deferred(), o = this, r = this.length, a = function() {
                                    --s || n.resolveWith(o, [ o ]);
                                };
                                for ("string" != typeof t && (e = t, t = void 0), t = t || "fx"; r--; ) (i = Z.get(o[r], t + "queueHooks")) && i.empty && (s++, 
                                i.empty.add(a));
                                return a(), n.promise(e);
                            }
                        });
                        var nt = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source, ot = RegExp("^(?:([+-])=|)(" + nt + ")([a-z%]*)$", "i"), rt = [ "Top", "Right", "Bottom", "Left" ], at = function(t, e) {
                        ...
                        function ht(t, e, i, s) {
                            var n, o, r = 20, a = s ? function() {
                                ...
                                return C.css(t, e, "");
                            }, l = a(), h = i && i[3] || (C.cssNumber[e] ? "" : "px"), c = (C.cssNumber[e] || "px" !== h && +l) && ot.exec(C.css(t, e));
                            if (c && c[3] !== h) {
                                for (l /= 2, h = h || c[3], c = +l || 1; r--; ) C.style(t, e, c + h), (1 - o) * (1 - (o = a() / l || .5)) <= 0 && (r = 0), 
                                c /= o;
                                C.style(t, e, (c *= 2) + h), i = i || [];
                            }
                            return i && (c = +c || +l || 0, n = i[1] ? c + (i[1] + 1) * i[2] : +i[2], s && (s.unit = h, 
                            s.start = c, s.end = n)), n;
                        }
                        var ct = {};
                        function ut(t) {
                            var e, i = t.ownerDocument, s = t.nodeName, n = ct[s];
                            return n || (e = i.body.appendChild(i.createElement(s)), n = C.css(e, "display"), 
                            e.parentNode.removeChild(e), "none" === n && (n = "block"), ct[s] = n, n);
                        }
                        function dt(t, e) {
                            for (var i, s, n = [], o = 0, r = t.length; o < r; o++) (s = t[o]).style && (i = s.style.display, 
                            e ? ("none" === i && (n[o] = Z.get(s, "display") || null, n[o] || (s.style.display = "")), 
                            "" === s.style.display && at(s) && (n[o] = ut(s))) : "none" !== i && (n[o] = "none", 
                            Z.set(s, "display", i)));
                        ...
                        var bt = /<|&#?\w+;/;
                        function yt(t, e, i, s, n) {
                            for (var o, r, a, l, h, c = e.createDocumentFragment(), u = [], d = 0, p = t.length; d < p; d++) if ((o = t[d]) || 0 === o) if ("object" === k(o)) C.merge(u, o.nodeType ? [ o ] : o); else if (bt.test(o)) {
                                for (r = r || c.appendChild(e.createElement("div")), a = mt[(ft.exec(o) || [ "", "" ])[1].toLowerCase()] || mt._default, 
                                r.innerHTML = a[1] + C.htmlPrefilter(o) + a[2], h = a[0]; h--; ) r = r.lastChild;
                                C.merge(u, r.childNodes), (r = c.firstChild).textContent = "";
                            } else u.push(e.createTextNode(o));
                            for (c.textContent = "", d = 0; o = u[d++]; ) if (s && C.inArray(o, s) > -1) n && n.push(o); else if (l = C.contains(o.ownerDocument, o), 
                            r = vt(c.appendChild(o), "script"), l && _t(r), i) for (h = 0; o = r[h++]; ) gt.test(o.type || "") && i.push(o);
                            return c;
                        }
                        ie = o.createDocumentFragment().appendChild(o.createElement("div")), (se = o.createElement("input")).setAttribute("type", "radio"), 
                        se.setAttribute("checked", "checked"), se.setAttribute("name", "t"), ie.appendChild(se), 
                        _.checkClone = ie.cloneNode(!0).cloneNode(!0).lastChild.checked, ie.innerHTML = "<textarea>x</textarea>", 
                        _.noCloneChecked = !!ie.cloneNode(!0).lastChild.defaultValue;
                        var wt = o.documentElement, xt = /^key/, kt = /^(?:mouse|pointer|contextmenu|drag|drop)|click/, Ct = /^([^.]*)(?:\.(.+)|)/;
                        function Dt() {
                            return !0;
                        }
                        function Tt() {
                        ...
                        function St(t, e, i, s, n, o) {
                            var r, a;
                            if ("object" == h(e)) {
                                for (a in "string" != typeof i && (s = s || i, i = void 0), e) St(t, a, i, s, e[a], o);
                                return t;
                            }
                            if (null == s && null == n ? (n = i, s = i = void 0) : null == n && ("string" == typeof i ? (n = s, 
                            s = void 0) : (n = s, s = i, i = void 0)), !1 === n) n = Tt; else if (!n) return t;
                        ...
                        C.event = {
                            ...
                            add: function(t, e, i, s, n) {
                                var o, r, a, l, h, c, u, d, p, f, g, m = Z.get(t);
                                if (m) for (i.handler && (i = (o = i).handler, n = o.selector), n && C.find.matchesSelector(wt, n), 
                                i.guid || (i.guid = C.guid++), (l = m.events) || (l = m.events = {}), (r = m.handle) || (r = m.handle = function(e) {
                                    return C.event.triggered !== e.type ? C.event.dispatch.apply(t, arguments) : void 0;
                                }), h = (e = (e || "").match(F) || [ "" ]).length; h--; ) p = g = (a = Ct.exec(e[h]) || [])[1], 
                                f = (a[2] || "").split(".").sort(), p && (u = C.event.special[p] || {}, p = (n ? u.delegateType : u.bindType) || p, 
                                u = C.event.special[p] || {}, c = C.extend({
                                    type: p,
                                    origType: g,
                                    data: s,
                                    handler: i,
                                    ...
                                    namespace: f.join(".")
                                }, o), (d = l[p]) || ((d = l[p] = []).delegateCount = 0, u.setup && !1 !== u.setup.call(t, s, f, r) || t.addEventListener && t.addEventListener(p, r)), 
                                u.add && (u.add.call(t, c), c.handler.guid || (c.handler.guid = i.guid)), n ? d.splice(d.delegateCount++, 0, c) : d.push(c), 
                                C.event.global[p] = !0);
                            },
                            remove: function(t, e, i, s, n) {
                                var o, r, a, l, h, c, u, d, p, f, g, m = Z.hasData(t) && Z.get(t);
                                if (m && (l = m.events)) {
                                    for (h = (e = (e || "").match(F) || [ "" ]).length; h--; ) if (p = g = (a = Ct.exec(e[h]) || [])[1], 
                                    f = (a[2] || "").split(".").sort(), p) {
                                        for (u = C.event.special[p] || {}, d = l[p = (s ? u.delegateType : u.bindType) || p] || [], 
                                        a = a[2] && RegExp("(^|\\.)" + f.join("\\.(?:.*\\.|)") + "(\\.|$)"), r = o = d.length; o--; ) c = d[o], 
                                        !n && g !== c.origType || i && i.guid !== c.guid || a && !a.test(c.namespace) || s && s !== c.selector && ("**" !== s || !c.selector) || (d.splice(o, 1), 
                                        c.selector && d.delegateCount--, u.remove && u.remove.call(t, c));
                                        r && !d.length && (u.teardown && !1 !== u.teardown.call(t, f, m.handle) || C.removeEvent(t, p, m.handle), 
                                        delete l[p]);
                                    } else for (p in l) C.event.remove(t, p + e[h], i, s, !0);
                                    C.isEmptyObject(l) && Z.remove(t, "handle events");
                                }
                            },
                            dispatch: function(t) {
                                var e, i, s, n, o, r, a = C.event.fix(t), l = Array(arguments.length), h = (Z.get(this, "events") || {})[a.type] || [], c = C.event.special[a.type] || {};
                                for (l[0] = a, e = 1; e < arguments.length; e++) l[e] = arguments[e];
                                if (a.delegateTarget = this, !c.preDispatch || !1 !== c.preDispatch.call(this, a)) {
                                    for (r = C.event.handlers.call(this, a, h), e = 0; (n = r[e++]) && !a.isPropagationStopped(); ) for (a.currentTarget = n.elem, 
                                    i = 0; (o = n.handlers[i++]) && !a.isImmediatePropagationStopped(); ) a.rnamespace && !a.rnamespace.test(o.namespace) || (a.handleObj = o, 
                                    a.data = o.data, void 0 !== (s = ((C.event.special[o.origType] || {}).handle || o.handler).apply(n.elem, l)) && !1 === (a.result = s) && (a.preventDefault(), 
                                    a.stopPropagation()));
                            ...
                            handlers: function(t, e) {
                                ...
                                if (l && h.nodeType && !("click" === t.type && t.button >= 1)) for (;h !== this; h = h.parentNode || this) if (1 === h.nodeType && ("click" !== t.type || !0 !== h.disabled)) {
                                    for (o = [], r = {}, i = 0; i < l; i++) void 0 === r[n = (s = e[i]).selector + " "] && (r[n] = s.needsContext ? C(n, this).index(h) > -1 : C.find(n, this, null, [ h ]).length), 
                                    r[n] && o.push(s);
                                    o.length && a.push({
                                        elem: h,
                                        handlers: o
                            ...
                            t && t.type ? (this.originalEvent = t, this.type = t.type, this.isDefaultPrevented = t.defaultPrevented || void 0 === t.defaultPrevented && !1 === t.returnValue ? Dt : Tt, 
                            ...
                            C.event.special[t] = {
                                ...
                                handle: function(t) {
                                    ...
                                    return s && (s === this || C.contains(this, s)) || (t.type = n.origType, i = n.handler.apply(this, arguments), 
                                    t.type = e), i;
                                }
                            };
                        })), C.fn.extend({
                            on: function(t, e, i, s) {
                                return St(this, t, e, i, s);
                            },
                            one: function(t, e, i, s) {
                                return St(this, t, e, i, s, 1);
                            },
                            off: function(t, e, i) {
                                var s, n;
                                if (t && t.preventDefault && t.handleObj) return s = t.handleObj, C(t.delegateTarget).off(s.namespace ? s.origType + "." + s.namespace : s.origType, s.selector, s.handler), 
                                this;
                                if ("object" == h(t)) {
                                    for (n in t) this.off(n, e, t[n]);
                                    return this;
                                }
                                return !1 !== e && "function" != typeof e || (i = e, e = void 0), !1 === i && (i = Tt), 
                                this.each((function() {
                                    C.event.remove(this, t, i, e);
                                }));
                            }
                        });
                        var Pt = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([a-z][^\/\0>\x20\t\r\n\f]*)[^>]*)\/>/gi, Mt = /<script|<style|<link/i, At = /checked\s*(?:[^=]|=\s*.checked.)/i, Et = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g;
                        function Ht(t, e) {
                        ...
                        function zt(t, e) {
                            var i, s, n, o, r, a, l, h;
                            if (1 === e.nodeType) {
                                if (Z.hasData(t) && (o = Z.access(t), r = Z.set(e, o), h = o.events)) for (n in delete r.handle, 
                                r.events = {}, h) for (i = 0, s = h[n].length; i < s; i++) C.event.add(e, n, h[n][i]);
                        ...
                        function Lt(t, e, i, s) {
                            e = c.apply([], e);
                            var n, o, r, a, l, h, u = 0, d = t.length, p = d - 1, f = e[0], g = b(f);
                            if (g || d > 1 && "string" == typeof f && !_.checkClone && At.test(f)) return t.each((function(n) {
                                var o = t.eq(n);
                                g && (e[0] = f.call(this, n, o.html())), Lt(o, e, i, s);
                            }));
                            if (d && (o = (n = yt(e, t[0].ownerDocument, !1, t, s)).firstChild, 1 === n.childNodes.length && (n = o), 
                            o || s)) {
                                for (a = (r = C.map(vt(n, "script"), Nt)).length; u < d; u++) l = n, u !== p && (l = C.clone(l, !0, !0), 
                                a && C.merge(r, vt(l, "script"))), i.call(t[u], l, u);
                                if (a) for (h = r[r.length - 1].ownerDocument, C.map(r, Ot), u = 0; u < a; u++) l = r[u], 
                                gt.test(l.type || "") && !Z.access(l, "globalEval") && C.contains(h, l) && (l.src && "module" !== (l.type || "").toLowerCase() ? C._evalUrl && C._evalUrl(l.src) : x(l.textContent.replace(Et, ""), h, l));
                            }
                            return t;
                        }
                        function Ft(t, e, i) {
                            for (var s, n = e ? C.filter(e, t) : t, o = 0; null != (s = n[o]); o++) i || 1 !== s.nodeType || C.cleanData(vt(s)), 
                            s.parentNode && (i && C.contains(s.ownerDocument, s) && _t(vt(s, "script")), s.parentNode.removeChild(s));
                            return t;
                        }
                        C.extend({
                            ...
                            clone: function(t, e, i) {
                                var s, n, o, r, a = t.cloneNode(!0), l = C.contains(t.ownerDocument, t);
                                if (!(_.noCloneChecked || 1 !== t.nodeType && 11 !== t.nodeType || C.isXMLDoc(t))) for (r = vt(a), 
                                s = 0, n = (o = vt(t)).length; s < n; s++) Wt(o[s], r[s]);
                                if (e) if (i) for (o = o || vt(t), r = r || vt(a), s = 0, n = o.length; s < n; s++) zt(o[s], r[s]); else zt(t, a);
                                return (r = vt(a, "script")).length > 0 && _t(r, !l && vt(t, "script")), a;
                            },
                            cleanData: function(t) {
                                for (var e, i, s, n = C.event.special, o = 0; void 0 !== (i = t[o]); o++) if (Q(i)) {
                                    if (e = i[Z.expando]) {
                                        if (e.events) for (s in e.events) n[s] ? C.event.remove(i, s) : C.removeEvent(i, s, e.handle);
                                        i[Z.expando] = void 0;
                                    }
                            ...
                            empty: function() {
                                for (var t, e = 0; null != (t = this[e]); e++) 1 === t.nodeType && (C.cleanData(vt(t, !1)), 
                                t.textContent = "");
                                return this;
                            },
                            clone: function(t, e) {
                            ...
                            html: function(t) {
                                return U(this, (function(t) {
                                    ...
                                    if ("string" == typeof t && !Mt.test(t) && !mt[(ft.exec(t) || [ "", "" ])[1].toLowerCase()]) {
                                        t = C.htmlPrefilter(t);
                                        try {
                                            for (;i < s; i++) 1 === (e = this[i] || {}).nodeType && (C.cleanData(vt(e, !1)), 
                                            e.innerHTML = t);
                                            e = 0;
                                        } catch (t) {}
                                    }
                            ...
                            replaceWith: function() {
                                ...
                                return Lt(this, arguments, (function(e) {
                                    ...
                                    0 > C.inArray(this, t) && (C.cleanData(vt(this)), i && i.replaceChild(e, this));
                                }), t);
                            }
                        }), C.each({
                            appendTo: "append",
                            ...
                            C.fn[t] = function(t) {
                                for (var i, s = [], n = C(t), o = n.length - 1, r = 0; r <= o; r++) i = r === o ? this : this.clone(!0), 
                                C(n[r])[e](i), u.apply(s, i.get());
                                return this.pushStack(s);
                            };
                        }));
                        var Rt = RegExp("^(" + nt + ")(?!px)[a-z%]+$", "i"), jt = function(e) {
                            var i = e.ownerDocument.defaultView;
                            return i && i.opener || (i = t), i.getComputedStyle(e);
                        }, qt = RegExp(rt.join("|"), "i");
                        function Bt(t, e, i) {
                            var s, n, o, r, a = t.style;
                            return (i = i || jt(t)) && ("" !== (r = i.getPropertyValue(e) || i[e]) || C.contains(t.ownerDocument, t) || (r = C.style(t, e)), 
                            !_.pixelBoxStyles() && Rt.test(r) && qt.test(e) && (s = a.width, n = a.minWidth, 
                            o = a.maxWidth, a.minWidth = a.maxWidth = a.width = r, r = i.width, a.width = s, 
                            a.minWidth = n, a.maxWidth = o)), void 0 !== r ? r + "" : r;
                        }
                        function Yt(t, e) {
                            return {
                                get: function() {
                        ...
                        !function() {
                            function e() {
                                if (c) {
                                    ...
                                    wt.appendChild(h).appendChild(c);
                                    var e = t.getComputedStyle(c);
                                    s = "1%" !== e.top, l = 12 === i(e.marginLeft), c.style.right = "60%", a = 36 === i(e.right), 
                                    n = 36 === i(e.width), c.style.position = "absolute", r = 36 === c.offsetWidth || "absolute", 
                                    wt.removeChild(h), c = null;
                                }
                            }
                            function i(t) {
                                return Math.round(parseFloat(t));
                            }
                            var s, n, r, a, l, h = o.createElement("div"), c = o.createElement("div");
                            c.style && (c.style.backgroundClip = "content-box", c.cloneNode(!0).style.backgroundClip = "", 
                            _.clearCloneStyle = "content-box" === c.style.backgroundClip, C.extend(_, {
                        ...
                        var $t = /^(none|table(?!-c[ea]).+)/, Ut = /^--/, Kt = {
                            ...
                            letterSpacing: "0",
                            fontWeight: "400"
                        }, Xt = [ "Webkit", "Moz", "ms" ], Gt = o.createElement("div").style;
                        function Qt(t) {
                            var e = C.cssProps[t];
                            return e || (e = C.cssProps[t] = function(t) {
                                if (t in Gt) return t;
                                for (var e = t[0].toUpperCase() + t.slice(1), i = Xt.length; i--; ) if ((t = Xt[i] + e) in Gt) return t;
                            }(t) || t), e;
                        }
                        function Jt(t, e, i) {
                            var s = ot.exec(e);
                        ...
                        function Zt(t, e, i, s, n, o) {
                            var r = "width" === e ? 1 : 0, a = 0, l = 0;
                            if (i === (s ? "border" : "content")) return 0;
                            for (;r < 4; r += 2) "margin" === i && (l += C.css(t, i + rt[r], !0, n)), s ? ("content" === i && (l -= C.css(t, "padding" + rt[r], !0, n)), 
                            "margin" !== i && (l -= C.css(t, "border" + rt[r] + "Width", !0, n))) : (l += C.css(t, "padding" + rt[r], !0, n), 
                            "padding" !== i ? l += C.css(t, "border" + rt[r] + "Width", !0, n) : a += C.css(t, "border" + rt[r] + "Width", !0, n));
                            return !s && o >= 0 && (l += Math.max(0, Math.ceil(t["offset" + e[0].toUpperCase() + e.slice(1)] - o - l - a - .5))), 
                            l;
                        }
                        function te(t, e, i) {
                            var s = jt(t), n = Bt(t, e, s), o = "border-box" === C.css(t, "boxSizing", !1, s), r = o;
                            if (Rt.test(n)) {
                                if (!i) return n;
                                n = "auto";
                            }
                            return r = r && (_.boxSizingReliable() || n === t.style[e]), "auto" !== n && (parseFloat(n) || "inline" !== C.css(t, "display", !1, s)) || (n = t["offset" + e[0].toUpperCase() + e.slice(1)], 
                            r = !0), (n = parseFloat(n) || 0) + Zt(t, e, i || (o ? "border" : "content"), r, s, n) + "px";
                        }
                        function ee(t, e, i, s, n) {
                            return new ee.prototype.init(t, e, i, s, n);
                        }
                        C.extend({
                            cssHooks: {
                                opacity: {
                            ...
                            style: function(t, e, i, s) {
                                if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
                                    var n, o, r, a = G(e), l = Ut.test(e), c = t.style;
                                    if (l || (e = Qt(a)), r = C.cssHooks[e] || C.cssHooks[a], void 0 === i) return r && "get" in r && void 0 !== (n = r.get(t, !1, s)) ? n : c[e];
                                    "string" == (o = h(i)) && (n = ot.exec(i)) && n[1] && (i = ht(t, e, n), o = "number"), 
                                    null != i && i == i && ("number" === o && (i += n && n[3] || (C.cssNumber[a] ? "" : "px")), 
                                    _.clearCloneStyle || "" !== i || 0 !== e.indexOf("background") || (c[e] = "inherit"), 
                                    r && "set" in r && void 0 === (i = r.set(t, i, s)) || (l ? c.setProperty(e, i) : c[e] = i));
                                }
                            },
                            css: function(t, e, i, s) {
                                var n, o, r, a = G(e);
                                return Ut.test(e) || (e = Qt(a)), (r = C.cssHooks[e] || C.cssHooks[a]) && "get" in r && (n = r.get(t, !0, i)), 
                                void 0 === n && (n = Bt(t, e, s)), "normal" === n && e in Vt && (n = Vt[e]), "" === i || i ? (o = parseFloat(n), 
                                !0 === i || isFinite(o) ? o || 0 : n) : n;
                            }
                        }), C.each([ "height", "width" ], (function(t, e) {
                            C.cssHooks[e] = {
                                get: function(t, i, s) {
                                    if (i) return !$t.test(C.css(t, "display")) || t.getClientRects().length && t.getBoundingClientRect().width ? te(t, e, s) : lt(t, Kt, (function() {
                                        return te(t, e, s);
                                    }));
                                },
                                set: function(t, i, s) {
                                    var n, o = jt(t), r = "border-box" === C.css(t, "boxSizing", !1, o), a = s && Zt(t, e, s, r, o);
                                    return r && _.scrollboxSize() === o.position && (a -= Math.ceil(t["offset" + e[0].toUpperCase() + e.slice(1)] - parseFloat(o[e]) - Zt(t, e, "border", !1, o) - .5)), 
                                    a && (n = ot.exec(i)) && "px" !== (n[3] || "px") && (t.style[e] = i, i = C.css(t, e)), 
                                    Jt(0, i, a);
                                }
                            };
                        })), C.cssHooks.marginLeft = Yt(_.reliableMarginLeft, (function(t, e) {
                            ...
                            css: function(t, e) {
                                return U(this, (function(t, e, i) {
                                    var s, n, o = {}, r = 0;
                                    if (Array.isArray(e)) {
                                        for (s = jt(t), n = e.length; r < n; r++) o[e[r]] = C.css(t, e[r], !1, s);
                                        return o;
                                    }
                            ...
                            init: function(t, e, i, s, n, o) {
                                this.elem = t, this.prop = i, this.easing = n || C.easing._default, this.options = e, 
                                this.start = this.now = this.cur(), this.end = s, this.unit = o || (C.cssNumber[i] ? "" : "px");
                            },
                            cur: function() {
                            ...
                            _default: "swing"
                        }, (C.fx = ee.prototype.init).step = {};
                        var ie, se, ne, oe, re = /^(?:toggle|show|hide)$/, ae = /queueHooks$/;
                        function le() {
                        ...
                        function ue(t, e, i) {
                            var s, n, o = 0, r = ue.prefilters.length, a = C.Deferred().always((function() {
                                delete l.elem;
                            })), l = function() {
                                if (n) return !1;
                                for (var e = ne || le(), i = Math.max(0, h.startTime + h.duration - e), s = 1 - (i / h.duration || 0), o = 0, r = h.tweens.length; o < r; o++) h.tweens[o].run(s);
                                return a.notifyWith(t, [ h, s, i ]), s < 1 && r ? i : (r || a.notifyWith(t, [ h, 1, 0 ]), 
                                a.resolveWith(t, [ h ]), !1);
                            }, h = a.promise({
                                elem: t,
                                props: C.extend({}, e),
                                ...
                                createTween: function(e, i) {
                                    var s = C.Tween(t, h.opts, e, i, h.opts.specialEasing[e] || h.opts.easing);
                            ...
                            for (function(t, e) {
                                var i, s, n, o, r;
                                for (i in t) if (n = e[s = G(i)], Array.isArray(o = t[i]) && (n = o[1], o = t[i] = o[0]), 
                                i !== s && (t[s] = o, delete t[i]), (r = C.cssHooks[s]) && "expand" in r) for (i in o = r.expand(o), 
                                delete t[s], o) i in t || (t[i] = o[i], e[i] = n); else e[s] = n;
                            }(c, h.opts.specialEasing); o < r; o++) if (s = ue.prefilters[o].call(h, t, c, h.opts)) return b(s.stop) && (C._queueHooks(h.elem, h.opts.queue).stop = s.stop.bind(s)), 
                            s;
                            return C.map(c, ce, h), b(h.opts.start) && h.opts.start.call(t, h), h.progress(h.opts.progress).done(h.opts.done, h.opts.complete).fail(h.opts.fail).always(h.opts.always), 
                        ...
                        C.Animation = C.extend(ue, {
                            ...
                            tweener: function(t, e) {
                                ...
                                for (var i, s = 0, n = t.length; s < n; s++) i = t[s], ue.tweeners[i] = ue.tweeners[i] || [], 
                                ue.tweeners[i].unshift(e);
                            },
                            prefilters: [ function(t, e, i) {
                                var s, n, o, r, a, l, h, c, u = this, d = {}, p = t.style, f = t.nodeType && at(t), g = Z.get(t, "fxshow");
                                for (s in i.queue || (null == (r = C._queueHooks(t, "fx")).unqueued && (r.unqueued = 0, 
                                ...
                                if ((l = !C.isEmptyObject(e)) || !C.isEmptyObject(d)) for (s in ("width" in e || "height" in e) && 1 === t.nodeType && (i.overflow = [ p.overflow, p.overflowX, p.overflowY ], 
                                null == (h = g && g.display) && (h = Z.get(t, "display")), "none" === (c = C.css(t, "display")) && (h ? c = h : (dt([ t ], !0), 
                                h = t.style.display || h, c = C.css(t, "display"), dt([ t ]))), ("inline" === c || "inline-block" === c && null != h) && "none" === C.css(t, "float") && (l || (u.done((function() {
                                    p.display = h;
                                })), null == h && (h = "none" === (c = p.display) ? "" : c)), p.display = "inline-block")), 
                                i.overflow && (p.overflow = "hidden", u.always((function() {
                                    p.overflow = i.overflow[0], p.overflowX = i.overflow[1], p.overflowY = i.overflow[2];
                                }))), l = !1, d) l || (g ? "hidden" in g && (f = g.hidden) : g = Z.access(t, "fxshow", {
                                    display: h
                                }), o && (g.hidden = !f), f && dt([ t ], !0), u.done((function() {
                                    for (s in f || dt([ t ]), Z.remove(t, "fxshow"), d) C.style(t, s, d[s]);
                                }))), l = ce(f ? g[s] : 0, s, u), s in g || (g[s] = l.start, f && (l.end = l.start, 
                                l.start = 0));
                            } ],
                            ...
                            var s = t && "object" == h(t) ? C.extend({}, t) : {
                                complete: i || !i && e || b(t) && t,
                                duration: t,
                                easing: i && e || e && !b(e) && e
                            };
                            return C.fx.off ? s.duration = 0 : "number" != typeof s.duration && (s.duration in C.fx.speeds ? s.duration = C.fx.speeds[s.duration] : s.duration = C.fx.speeds._default), 
                            null != s.queue && !0 !== s.queue || (s.queue = "fx"), s.old = s.complete, s.complete = function() {
                            ...
                            animate: function(t, e, i, s) {
                                var n = C.isEmptyObject(t), o = C.speed(e, i, s), r = function() {
                                    var e = ue(this, C.extend({}, t), o);
                            ...
                            stop: function(t, e, i) {
                                ...
                                this.each((function() {
                                    var e = !0, n = null != t && t + "queueHooks", o = C.timers, r = Z.get(this);
                            ...
                            finish: function(t) {
                                return !1 !== t && (t = t || "fx"), this.each((function() {
                                    var e, i = Z.get(this), s = i[t + "queue"], n = i[t + "queueHooks"], o = C.timers, r = s ? s.length : 0;
                                    for (i.finish = !0, C.queue(this, t, []), n && n.stop && n.stop.call(this, !0), 
                            ...
                            oe || (oe = !0, function e() {
                                oe && (!1 === o.hidden && t.requestAnimationFrame ? t.requestAnimationFrame(e) : t.setTimeout(e, C.fx.interval), 
                                C.fx.tick());
                            }());
                        }, C.fx.stop = function() {
                            oe = null;
                            ...
                            return e = C.fx && C.fx.speeds[e] || e, i = i || "fx", this.queue(i, (function(i, s) {
                                var n = t.setTimeout(i, e);
                                s.stop = function() {
                                    t.clearTimeout(n);
                                };
                            }));
                        }, de = o.createElement("input"), pe = o.createElement("select").appendChild(o.createElement("option")), 
                        de.type = "checkbox", _.checkOn = "" !== de.value, _.optSelected = pe.selected, 
                        (de = o.createElement("input")).value = "t", de.type = "radio", _.radioValue = "t" === de.value;
                        var de, pe, fe, ge = C.expr.attrHandle;
                        C.fn.extend({
                            attr: function(t, e) {
                            ...
                            attr: function(t, e, i) {
                                ...
                                if (3 !== o && 8 !== o && 2 !== o) return void 0 === t.getAttribute ? C.prop(t, e, i) : (1 === o && C.isXMLDoc(t) || (n = C.attrHooks[e.toLowerCase()] || (C.expr.match.bool.test(e) ? fe : void 0)), 
                                void 0 !== i ? null === i ? void C.removeAttr(t, e) : n && "set" in n && void 0 !== (s = n.set(t, i, e)) ? s : (t.setAttribute(e, i + ""), 
                                i) : n && "get" in n && null !== (s = n.get(t, e)) ? s : null == (s = C.find.attr(t, e)) ? void 0 : s);
                            },
                            attrHooks: {
                                type: {
                                    set: function(t, e) {
                            ...
                            var i = ge[e] || C.find.attr;
                            ge[e] = function(t, e, s) {
                                var n, o, r = e.toLowerCase();
                                return s || (o = ge[r], ge[r] = n, n = null != i(t, e, s) ? r : null, ge[r] = o), 
                                n;
                            };
                        }));
                        ...
                        C.fn.extend({
                            ...
                            prop: function(t, e, i) {
                                var s, n, o = t.nodeType;
                                if (3 !== o && 8 !== o && 2 !== o) return 1 === o && C.isXMLDoc(t) || (e = C.propFix[e] || e, 
                                n = C.propHooks[e]), void 0 !== i ? n && "set" in n && void 0 !== (s = n.set(t, i, e)) ? s : t[e] = i : n && "get" in n && null !== (s = n.get(t, e)) ? s : t[e];
                            },
                            propHooks: {
                                tabIndex: {
                                    get: function(t) {
                            ...
                            addClass: function(t) {
                                ...
                                if ((e = ye(t)).length) for (;i = this[l++]; ) if (n = be(i), s = 1 === i.nodeType && " " + _e(n) + " ") {
                                    for (r = 0; o = e[r++]; ) 0 > s.indexOf(" " + o + " ") && (s += o + " ");
                                    n !== (a = _e(s)) && i.setAttribute("class", a);
                                }
                                return this;
                            },
                            ...
                            toggleClass: function(t, e) {
                                var i = h(t), s = "string" === i || Array.isArray(t);
                                return "boolean" == typeof e && s ? e ? this.addClass(t) : this.removeClass(t) : b(t) ? this.each((function(i) {
                                    C(this).toggleClass(t.call(this, i, be(this), e), e);
                                })) : this.each((function() {
                                    var e, n, o, r;
                                    if (s) for (n = 0, o = C(this), r = ye(t); e = r[n++]; ) o.hasClass(e) ? o.removeClass(e) : o.addClass(e); else void 0 !== t && "boolean" !== i || ((e = be(this)) && Z.set(this, "__className__", e), 
                                    this.setAttribute && this.setAttribute("class", e || !1 === t ? "" : Z.get(this, "__className__") || ""));
                                }));
                            },
                            hasClass: function(t) {
                                var e, i, s = 0;
                                for (e = " " + t + " "; i = this[s++]; ) if (1 === i.nodeType && (" " + _e(be(i)) + " ").indexOf(e) > -1) return !0;
                                return !1;
                            }
                        });
                        var we = /\r/g;
                        C.fn.extend({
                            val: function(t) {
                                var e, i, s, n = this[0];
                                return arguments.length ? (s = b(t), this.each((function(i) {
                                    var n;
                                    1 === this.nodeType && (null == (n = s ? t.call(this, i, C(this).val()) : t) ? n = "" : "number" == typeof n ? n += "" : Array.isArray(n) && (n = C.map(n, (function(t) {
                                        return null == t ? "" : t + "";
                                    }))), (e = C.valHooks[this.type] || C.valHooks[this.nodeName.toLowerCase()]) && "set" in e && void 0 !== e.set(this, n, "value") || (this.value = n));
                                }))) : n ? (e = C.valHooks[n.type] || C.valHooks[n.nodeName.toLowerCase()]) && "get" in e && void 0 !== (i = e.get(n, "value")) ? i : "string" == typeof (i = n.value) ? i.replace(we, "") : null == i ? "" : i : void 0;
                            }
                        }), C.extend({
                            valHooks: {
                                option: {
                                ...
                                select: {
                                    ...
                                    set: function(t, e) {
                                        for (var i, s, n = t.options, o = C.makeArray(e), r = n.length; r--; ) ((s = n[r]).selected = C.inArray(C.valHooks.option.get(s), o) > -1) && (i = !0);
                        ...
                        C.extend(C.event, {
                            trigger: function(e, i, s, n) {
                                var r, a, l, c, u, d, p, f, m = [ s || o ], v = g.call(e, "type") ? e.type : e, _ = g.call(e, "namespace") ? e.namespace.split(".") : [];
                                if (a = f = l = s = s || o, 3 !== s.nodeType && 8 !== s.nodeType && !xe.test(v + C.event.triggered) && (v.indexOf(".") > -1 && (v = (_ = v.split(".")).shift(), 
                                _.sort()), u = 0 > v.indexOf(":") && "on" + v, (e = e[C.expando] ? e : new C.Event(v, "object" == h(e) && e)).isTrigger = n ? 2 : 3, 
                                e.namespace = _.join("."), e.rnamespace = e.namespace ? RegExp("(^|\\.)" + _.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, 
                                e.result = void 0, e.target || (e.target = s), i = null == i ? [ e ] : C.makeArray(i, [ e ]), 
                                p = C.event.special[v] || {}, n || !p.trigger || !1 !== p.trigger.apply(s, i))) {
                                    if (!n && !p.noBubble && !y(s)) {
                                        for (c = p.delegateType || v, xe.test(c + v) || (a = a.parentNode); a; a = a.parentNode) m.push(a), 
                                        l = a;
                                        l === (s.ownerDocument || o) && m.push(l.defaultView || l.parentWindow || t);
                                    }
                                    for (r = 0; (a = m[r++]) && !e.isPropagationStopped(); ) f = a, e.type = r > 1 ? c : p.bindType || v, 
                                    (d = (Z.get(a, "events") || {})[e.type] && Z.get(a, "handle")) && d.apply(a, i), 
                                    (d = u && a[u]) && d.apply && Q(a) && (e.result = d.apply(a, i), !1 === e.result && e.preventDefault());
                                    return e.type = v, n || e.isDefaultPrevented() || p._default && !1 !== p._default.apply(m.pop(), i) || !Q(s) || u && b(s[v]) && !y(s) && ((l = s[u]) && (s[u] = null), 
                                    C.event.triggered = v, e.isPropagationStopped() && f.addEventListener(v, ke), s[v](), 
                                    e.isPropagationStopped() && f.removeEventListener(v, ke), C.event.triggered = void 0, 
                                    l && (s[u] = l)), e.result;
                                }
                            },
                            ...
                            C.event.special[e] = {
                                setup: function() {
                                    var s = this.ownerDocument || this, n = Z.access(s, e);
                                    n || s.addEventListener(t, i, !0), Z.access(s, e, (n || 0) + 1);
                                },
                                teardown: function() {
                                    var s = this.ownerDocument || this, n = Z.access(s, e) - 1;
                                    n ? Z.access(s, e, n) : (s.removeEventListener(t, i, !0), Z.remove(s, e));
                                }
                            };
                        }));
                        var Ce = t.location, De = Date.now(), Te = /\?/;
                        C.parseXML = function(e) {
                            ...
                            return i && !i.getElementsByTagName("parsererror").length || C.error("Invalid XML: " + e), 
                            i;
                        };
                        var Ie = /\[\]$/, Se = /\r?\n/g, Pe = /^(?:submit|button|image|reset|file)$/i, Me = /^(?:input|select|textarea|keygen)/i;
                        function Ae(t, e, i, s) {
                            var n;
                            if (Array.isArray(e)) C.each(e, (function(e, n) {
                                i || Ie.test(t) ? s(t, n) : Ae(t + "[" + ("object" == h(n) && null != n ? e : "") + "]", n, i, s);
                            })); else if (i || "object" !== k(e)) s(t, e); else for (n in e) Ae(t + "[" + n + "]", e[n], i, s);
                        }
                        C.param = function(t, e) {
                            ...
                            serializeArray: function() {
                                return this.map((function() {
                                    ...
                                    var t = this.type;
                                    return this.name && !C(this).is(":disabled") && Me.test(this.nodeName) && !Pe.test(t) && (this.checked || !pt.test(t));
                                })).map((function(t, e) {
                                    var i = C(this).val();
                        ...
                        var Ee = /%20/g, He = /#.*$/, Ne = /([?&])_=[^&]*/, Oe = /^(.*?):[ \t]*([^\r\n]*)$/gm, ze = /^(?:GET|HEAD)$/, We = /^\/\//, Le = {}, Fe = {}, Re = "*/".concat("*"), je = o.createElement("a");
                        function qe(t) {
                            return function(e, i) {
                                "string" != typeof e && (i = e, e = "*");
                                var s, n = 0, o = e.toLowerCase().match(F) || [];
                                if (b(i)) for (;s = o[n++]; ) "+" === s[0] ? (t[s = s.slice(1) || "*"] = t[s] || []).unshift(i) : (t[s] = t[s] || []).push(i);
                            };
                        }
                        function Be(t, e, i, s) {
                            var n = {}, o = t === Fe;
                            function r(a) {
                                var l;
                                return n[a] = !0, C.each(t[a] || [], (function(t, a) {
                                    var h = a(e, i, s);
                        ...
                        je.href = Ce.href, C.extend({
                            ...
                            ajaxTransport: qe(Fe),
                            ajax: function(e, i) {
                                "object" == h(e) && (i = e, e = void 0);
                                var s, n, r, a, l, c, u, d, p, f, g = C.ajaxSetup({}, i = i || {}), m = g.context || g, v = g.context && (m.nodeType || m.jquery) ? C(m) : C.event, _ = C.Deferred(), b = C.Callbacks("once memory"), y = g.statusCode || {}, w = {}, x = {}, k = "canceled", D = {
                                    readyState: 0,
                                    ...
                                    setRequestHeader: function(t, e) {
                                        return null == u && (w[t = x[t.toLowerCase()] = x[t.toLowerCase()] || t] = e), this;
                                    },
                                    ...
                                    statusCode: function(t) {
                                        var e;
                                        if (t) if (u) D.always(t[D.status]); else for (e in t) y[e] = [ y[e], t[e] ];
                                        return this;
                                    },
                                    abort: function(t) {
                                        var e = t || k;
                                ...
                                if (_.promise(D), g.url = ((e || g.url || Ce.href) + "").replace(We, Ce.protocol + "//"), 
                                g.type = i.method || i.type || g.method || g.type, g.dataTypes = (g.dataType || "*").toLowerCase().match(F) || [ "" ], 
                                null == g.crossDomain) {
                                    c = o.createElement("a");
                                    try {
                                        c.href = g.url, c.href = c.href, g.crossDomain = je.protocol + "//" + je.host != c.protocol + "//" + c.host;
                                    } catch (t) {
                                        g.crossDomain = !0;
                                    }
                                }
                                if (g.data && g.processData && "string" != typeof g.data && (g.data = C.param(g.data, g.traditional)), 
                                Be(Le, g, i, D), u) return D;
                                for (p in (d = C.event && g.global) && 0 == C.active++ && C.event.trigger("ajaxStart"), 
                                g.type = g.type.toUpperCase(), g.hasContent = !ze.test(g.type), n = g.url.replace(He, ""), 
                                g.hasContent ? g.data && g.processData && 0 === (g.contentType || "").indexOf("application/x-www-form-urlencoded") && (g.data = g.data.replace(Ee, "+")) : (f = g.url.slice(n.length), 
                                g.data && (g.processData || "string" == typeof g.data) && (n += (Te.test(n) ? "&" : "?") + g.data, 
                                delete g.data), !1 === g.cache && (n = n.replace(Ne, "$1"), f = (Te.test(n) ? "&" : "?") + "_=" + De++ + f), 
                                g.url = n + f), g.ifModified && (C.lastModified[n] && D.setRequestHeader("If-Modified-Since", C.lastModified[n]), 
                                C.etag[n] && D.setRequestHeader("If-None-Match", C.etag[n])), (g.data && g.hasContent && !1 !== g.contentType || i.contentType) && D.setRequestHeader("Content-Type", g.contentType), 
                                ...
                                g.headers) D.setRequestHeader(p, g.headers[p]);
                                if (g.beforeSend && (!1 === g.beforeSend.call(m, D, g) || u)) return D.abort();
                                if (k = "abort", b.add(g.complete), D.done(g.success), D.fail(g.error), s = Be(Fe, g, i, D)) {
                                ...
                                function T(e, i, o, a) {
                                    var h, c, p, f, w, x = i;
                                    u || (u = !0, l && t.clearTimeout(l), s = void 0, r = a || "", D.readyState = e > 0 ? 4 : 0, 
                                    h = e >= 200 && e < 300 || 304 === e, o && (f = function(t, e, i) {
                                        for (var s, n, o, r, a = t.contents, l = t.dataTypes; "*" === l[0]; ) l.shift(), 
                                        ...
                                        !l && s && t.dataFilter && (e = t.dataFilter(e, t.dataType)), l = o, o = c.shift()) if ("*" === o) o = l; else if ("*" !== l && l !== o) {
                                    ...
                                    }(g, f, D, h), h ? (g.ifModified && ((w = D.getResponseHeader("Last-Modified")) && (C.lastModified[n] = w), 
                                    (w = D.getResponseHeader("etag")) && (C.etag[n] = w)), 204 === e || "HEAD" === g.type ? x = "nocontent" : 304 === e ? x = "notmodified" : (x = f.state, 
                                    c = f.data, h = !(p = f.error))) : (p = x, !e && x || (x = "error", e < 0 && (e = 0))), 
                                    D.status = e, D.statusText = (i || x) + "", h ? _.resolveWith(m, [ c, x, D ]) : _.rejectWith(m, [ D, x, p ]), 
                                    D.statusCode(y), y = void 0, d && v.trigger(h ? "ajaxSuccess" : "ajaxError", [ D, g, h ? c : p ]), 
                                    b.fireWith(m, [ D, x ]), d && (v.trigger("ajaxComplete", [ D, g ]), --C.active || C.event.trigger("ajaxStop")));
                                }
                                return D;
                            },
                            ...
                            C[e] = function(t, i, s, n) {
                                return b(i) && (n = n || s, s = i, i = void 0), C.ajax(C.extend({
                                    url: t,
                                    type: e,
                                    dataType: n,
                                    data: i,
                            ...
                            wrapAll: function(t) {
                                var e;
                                return this[0] && (b(t) && (t = t.call(this[0])), e = C(t, this[0].ownerDocument).eq(0).clone(!0), 
                        ...
                        _.cors = !!Ue && "withCredentials" in Ue, _.ajax = Ue = !!Ue, C.ajaxTransport((function(e) {
                            var i, s;
                            if (_.cors || Ue && !e.crossDomain) return {
                                send: function(n, o) {
                                    var r, a = e.xhr();
                                    if (a.open(e.type, e.url, e.async, e.username, e.password), e.xhrFields) for (r in e.xhrFields) a[r] = e.xhrFields[r];
                                    for (r in e.mimeType && a.overrideMimeType && a.overrideMimeType(e.mimeType), e.crossDomain || n["X-Requested-With"] || (n["X-Requested-With"] = "XMLHttpRequest"), 
                                    n) a.setRequestHeader(r, n[r]);
                                    i = function(t) {
                                        return function() {
                                            i && (i = s = a.onload = a.onerror = a.onabort = a.ontimeout = a.onreadystatechange = null, 
                        ...
                        C.ajaxSetup({
                            ...
                            jsonpCallback: function() {
                                var t = Ve.pop() || C.expando + "_" + De++;
                                return this[t] = !0, t;
                            }
                        }), C.ajaxPrefilter("json jsonp", (function(e, i, s) {
                            var n, o, r, a = !1 !== e.jsonp && (Xe.test(e.url) ? "url" : "string" == typeof e.data && 0 === (e.contentType || "").indexOf("application/x-www-form-urlencoded") && Xe.test(e.data) && "data");
                            if (a || "jsonp" === e.dataTypes[0]) return n = e.jsonpCallback = b(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback, 
                            a ? e[a] = e[a].replace(Xe, "$1" + n) : !1 !== e.jsonp && (e.url += (Te.test(e.url) ? "&" : "?") + e.jsonp + "=" + n), 
                            e.converters["script json"] = function() {
                                return r || C.error(n + " was not called"), r[0];
                            }, e.dataTypes[0] = "json", o = t[n], t[n] = function() {
                                r = arguments;
                            }, s.always((function() {
                                void 0 === o ? C(t).removeProp(n) : t[n] = o, e[n] && (e.jsonpCallback = i.jsonpCallback, 
                                Ve.push(n)), r && b(o) && o(r[0]), r = o = void 0;
                            })), "script";
                        })), _.createHTMLDocument = ((Ke = o.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>", 
                        2 === Ke.childNodes.length), C.parseHTML = function(t, e, i) {
                            var s, n, r;
                            return "string" != typeof t ? [] : ("boolean" == typeof e && (i = e, e = !1), e || (_.createHTMLDocument ? ((s = (e = o.implementation.createHTMLDocument("")).createElement("base")).href = o.location.href, 
                            e.head.appendChild(s)) : e = o), r = !i && [], (n = E.exec(t)) ? [ e.createElement(n[1]) ] : (n = yt([ t ], e, r), 
                            r && r.length && C(r).remove(), C.merge([], n.childNodes)));
                        }, C.fn.load = function(t, e, i) {
                            var s, n, o, r = this, a = t.indexOf(" ");
                            return a > -1 && (s = _e(t.slice(a)), t = t.slice(0, a)), b(e) ? (i = e, e = void 0) : e && "object" == h(e) && (n = "POST"), 
                            r.length > 0 && C.ajax({
                                url: t,
                                type: n || "GET",
                                dataType: "html",
                                ...
                                o = arguments, r.html(s ? C("<div>").append(C.parseHTML(t)).find(s) : t);
                            ...
                            setOffset: function(t, e, i) {
                                var s, n, o, r, a, l, h = C.css(t, "position"), c = C(t), u = {};
                                "static" === h && (t.style.position = "relative"), a = c.offset(), o = C.css(t, "top"), 
                                l = C.css(t, "left"), ("absolute" === h || "fixed" === h) && (o + l).indexOf("auto") > -1 ? (r = (s = c.position()).top, 
                                n = s.left) : (r = parseFloat(o) || 0, n = parseFloat(l) || 0), b(e) && (e = e.call(t, i, C.extend({}, a))), 
                            ...
                            position: function() {
                                if (this[0]) {
                                    var t, e, i, s = this[0], n = {
                                        top: 0,
                                        left: 0
                                    };
                                    if ("fixed" === C.css(s, "position")) e = s.getBoundingClientRect(); else {
                                        ...
                                        t && t !== s && 1 === t.nodeType && ((n = C(t).offset()).top += C.css(t, "borderTopWidth", !0), 
                            ...
                            C.cssHooks[e] = Yt(_.pixelPosition, (function(t, i) {
                                if (i) return i = Bt(t, e), Rt.test(i) ? C(t).position()[e] + "px" : i;
                            }));
                        })), C.each({
                            Height: "height",
                            Width: "width"
                            ...
                            C.each({
                                ...
                                C.fn[s] = function(n, o) {
                                    ...
                                    return U(this, (function(e, i, n) {
                                        var o;
                                        return y(e) ? 0 === s.indexOf("outer") ? e["inner" + t] : e.document.documentElement["client" + t] : 9 === e.nodeType ? (o = e.documentElement, 
                                        Math.max(e.body["scroll" + t], o["scroll" + t], e.body["offset" + t], o["offset" + t], o["client" + t])) : void 0 === n ? C.css(e, i, a) : C.style(e, i, n, a);
                                    }), e, r ? n : void 0, r);
                                };
                            }));
                            ...
                            var i, s, n;
                            if ("string" == typeof e && (i = t[e], e = t, t = i), b(t)) return s = l.call(arguments, 2), 
                            (n = function() {
                                return t.apply(e || this, s.concat(l.call(arguments)));
                            }).guid = t.guid = t.guid || C.guid++, n;
                        }, C.holdReady = function(t) {
                            t ? C.readyWait++ : C.ready(!0);
                        }, C.isArray = Array.isArray, C.parseJSON = JSON.parse, C.nodeName = A, C.isFunction = b, 
                        C.isWindow = y, C.camelCase = G, C.type = k, C.now = Date.now, C.isNumeric = function(t) {
                            var e = C.type(t);
                            return ("number" === e || "string" === e) && !isNaN(t - parseFloat(t));
                        }, void 0 !== (s = function() {
                            return C;
                        }.apply(n = {}, [])) || (s = n);
                        var Ge = t.jQuery, Qe = t.$;
                        return C.noConflict = function(e) {
                            return t.$ === C && (t.$ = Qe), e && t.jQuery === C && (t.jQuery = Ge), C;
                        }, e || (t.jQuery = t.$ = C), C;
                    })), o = function(t) {
                        function e() {
                        ...
                        function s() {
                            t.datepicker._isDisabledDatepicker(r.inline ? r.dpDiv.parent()[0] : r.input[0]) || (t(this).parents(".ui-datepicker-calendar").find("a").removeClass("ui-state-hover"), 
                        ...
                        var r, a, l, c = 0, u = Array.prototype.slice;
                        t.cleanData = (a = t.cleanData, function(e) {
                            ...
                            for (var i, s, n = u.call(arguments, 1), o = 0, r = n.length; r > o; o++) for (i in n[o]) s = n[o][i], 
                            n[o].hasOwnProperty(i) && void 0 !== s && (e[i] = t.isPlainObject(s) ? t.isPlainObject(e[i]) ? t.widget.extend({}, e[i], s) : t.widget.extend({}, s) : s);
                            return e;
                        }, t.widget.bridge = function(e, i) {
                            var s = i.prototype.widgetFullName || e;
                            t.fn[e] = function(n) {
                                var o = "string" == typeof n, r = u.call(arguments, 1), a = this;
                                return o ? this.length || "instance" !== n ? this.each((function() {
                                    var i, o = t.data(this, s);
                                    return "instance" === n ? (a = o, !1) : o ? t.isFunction(o[n]) && "_" !== n.charAt(0) ? (i = o[n].apply(o, r)) !== o && void 0 !== i ? (a = i && i.jquery ? a.pushStack(i.get()) : i, 
                                    !1) : void 0 : t.error("no such method '" + n + "' for " + e + " widget instance") : t.error("cannot call methods on " + e + " prior to initialization; attempted to call method '" + n + "'");
                                })) : a = void 0 : (r.length && (n = t.widget.extend.apply(null, [ n ].concat(r))), 
                                this.each((function() {
                                    var e = t.data(this, s);
                            ...
                            option: function(e, i) {
                                ...
                                if ("string" == typeof e) if (r = {}, e = (s = e.split(".")).shift(), s.length) {
                                    for (n = r[e] = t.widget.extend({}, this.options[e]), o = 0; s.length - 1 > o; o++) n[s[o]] = n[s[o]] || {}, 
                                    n = n[s[o]];
                            ...
                            _classes: function(e) {
                                function i(i, o) {
                                    var r, a;
                                    for (a = 0; i.length > a; a++) r = n.classesElementLookup[i[a]] || t(), r = e.add ? t(t.unique(r.get().concat(e.element.get()))) : t(r.not(e.element).get()), 
                                    n.classesElementLookup[i[a]] = r, s.push(i[a]), o && e.classes[i[a]] && s.push(e.classes[i[a]]);
                                }
                                var s = [], n = this;
                                return e = t.extend({
                            ...
                            var s, n = Math.max, o = Math.abs, r = /left|center|right/, a = /top|center|bottom/, l = /[\+\-]\d+(\.[\d]+)?%?/, h = /^\w+/, c = /%$/, u = t.fn.position;
                            t.position = {
                                scrollbarWidth: function() {
                                    ...
                                    return t("body").append(n), e = o.offsetWidth, n.css("overflow", "scroll"), e === (i = o.offsetWidth) && (i = n[0].clientWidth), 
                                    n.remove(), s = e - i;
                                },
                                ...
                                s = t.extend({}, s);
                                var c, d, p, f, g, m, v, _, b = t(s.of), y = t.position.getWithinInfo(s.within), w = t.position.getScrollInfo(y), x = (s.collision || "flip").split(" "), k = {};
                                return m = 9 === (_ = (v = b)[0]).nodeType ? {
                                    ...
                                    offset: v.offset()
                                }, b[0].preventDefault && (s.at = "left top"), d = m.width, p = m.height, f = m.offset, 
                                g = t.extend({}, f), t.each([ "my", "at" ], (function() {
                                    var t, e, i = (s[this] || "").split(" ");
                                    1 === i.length && (i = r.test(i[0]) ? i.concat([ "center" ]) : a.test(i[0]) ? [ "center" ].concat(i) : [ "center", "center" ]), 
                                    i[0] = r.test(i[0]) ? i[0] : "center", i[1] = a.test(i[1]) ? i[1] : "center", t = l.exec(i[0]), 
                                    e = l.exec(i[1]), k[this] = [ t ? t[0] : 0, e ? e[0] : 0 ], s[this] = [ h.exec(i[0])[0], h.exec(i[1])[0] ];
                                })), 1 === x.length && (x[1] = x[0]), "right" === s.at[0] ? g.left += d : "center" === s.at[0] && (g.left += d / 2), 
                                "bottom" === s.at[1] ? g.top += p : "center" === s.at[1] && (g.top += p / 2), c = e(k.at, d, p), 
                                g.left += c[0], g.top += c[1], this.each((function() {
                                    var r, a, l = t(this), h = l.outerWidth(), u = l.outerHeight(), m = i(this, "marginLeft"), v = i(this, "marginTop"), _ = h + m + i(this, "marginRight") + w.width, C = u + v + i(this, "marginBottom") + w.height, D = t.extend({}, g), T = e(k.my, l.outerWidth(), l.outerHeight());
                                    "right" === s.my[0] ? D.left -= h : "center" === s.my[0] && (D.left -= h / 2), "bottom" === s.my[1] ? D.top -= u : "center" === s.my[1] && (D.top -= u / 2), 
                                    D.left += T[0], D.top += T[1], r = {
                                        marginLeft: m,
                                        marginTop: v
                                        ...
                                        var e = f.left - D.left, i = e + d - h, r = f.top - D.top, a = r + p - u, c = {
                                            target: {
                                                element: b,
                                                left: f.left,
                                                top: f.top,
                                        ...
                                        h > d && d > o(e + i) && (c.horizontal = "center"), u > p && p > o(r + a) && (c.vertical = "middle"), 
                                        c.important = n(o(e), o(i)) > n(o(r), o(a)) ? "horizontal" : "vertical", s.using.call(this, t, c);
                                    }), l.offset(t.extend(D, {
                                        using: a
                                    }));
                                }));
                                ...
                                fit: {
                                    left: function(t, e) {
                                        var i, s = e.within, o = s.isWindow ? s.scrollLeft : s.offset.left, r = s.width, a = t.left - e.collisionPosition.marginLeft, l = o - a, h = a + e.collisionWidth - r - o;
                                        e.collisionWidth > r ? l > 0 && 0 >= h ? (i = t.left + l + e.collisionWidth - r - o, 
                                        t.left += l - i) : t.left = h > 0 && 0 >= l ? o : l > h ? o + r - e.collisionWidth : o : l > 0 ? t.left += l : h > 0 ? t.left -= h : t.left = n(t.left - a, t.left);
                                    },
                                    top: function(t, e) {
                                        var i, s = e.within, o = s.isWindow ? s.scrollTop : s.offset.top, r = e.within.height, a = t.top - e.collisionPosition.marginTop, l = o - a, h = a + e.collisionHeight - r - o;
                                        e.collisionHeight > r ? l > 0 && 0 >= h ? (i = t.top + l + e.collisionHeight - r - o, 
                                        t.top += l - i) : t.top = h > 0 && 0 >= l ? o : l > h ? o + r - e.collisionHeight : o : l > 0 ? t.top += l : h > 0 ? t.top -= h : t.top = n(t.top - a, t.top);
                                    }
                                },
                                flip: {
                                    left: function(t, e) {
                                        var i, s, n = e.within, r = n.offset.left + n.scrollLeft, a = n.width, l = n.isWindow ? n.scrollLeft : n.offset.left, h = t.left - e.collisionPosition.marginLeft, c = h - l, u = h + e.collisionWidth - a - l, d = "left" === e.my[0] ? -e.elemWidth : "right" === e.my[0] ? e.elemWidth : 0, p = "left" === e.at[0] ? e.targetWidth : "right" === e.at[0] ? -e.targetWidth : 0, f = -2 * e.offset[0];
                                    ...
                                    top: function(t, e) {
                                        var i, s, n = e.within, r = n.offset.top + n.scrollTop, a = n.height, l = n.isWindow ? n.scrollTop : n.offset.top, h = t.top - e.collisionPosition.marginTop, c = h - l, u = h + e.collisionHeight - a - l, d = "top" === e.my[1] ? -e.elemHeight : "bottom" === e.my[1] ? e.elemHeight : 0, p = "top" === e.at[1] ? e.targetHeight : "bottom" === e.at[1] ? -e.targetHeight : 0, f = -2 * e.offset[1];
                        ...
                        var d, p, f, g = "ui-effects-", m = "ui-effects-style", v = "ui-effects-animated", _ = t;
                        t.effects = {
                            effect: {}
                        }, function(t, e) {
                            function i(t, e, i) {
                                var s = c[e.type] || {};
                                return null == t ? i || !e.def ? null : e.def : isNaN(t = s.floor ? ~~t : parseFloat(t)) ? e.def : s.mod ? (t + s.mod) % s.mod : 0 > t ? 0 : t > s.max ? s.max : t;
                            }
                            function s(i) {
                                var s = l(), n = s._rgba = [];
                            ...
                            p(h, (function(t, e) {
                                ...
                                var e = t[0] / 255, i = t[1] / 255, s = t[2] / 255, n = t[3], o = Math.max(e, i, s), r = Math.min(e, i, s), a = o - r, l = o + r, h = .5 * l;
                                return [ Math.round(r === o ? 0 : e === o ? 60 * (i - s) / a + 360 : i === o ? 60 * (s - e) / a + 120 : 60 * (e - i) / a + 240) % 360, 0 === a ? 0 : .5 >= h ? a / l : a / (2 - l), h, null == n ? 1 : n ];
                            ...
                            var i, s, n, o = [ "add", "remove", "toggle" ], r = {
                                border: 1,
                                borderBottom: 1,
                                borderColor: 1,
                                borderLeft: 1,
                            ...
                            t.each([ "borderLeftStyle", "borderRightStyle", "borderBottomStyle", "borderTopStyle" ], (function(e, i) {
                                ...
                                return this.queue((function() {
                                    var s, n = t(this), a = n.attr("class") || "", h = l.children ? n.find("*").addBack() : n;
                                    h = h.map((function() {
                                        return {
                                            el: t(this),
                                            start: e(this)
                                        ...
                                        return this.end = e(this.el[0]), this.diff = function(e, i) {
                                            var s, n, o = {};
                                            for (s in i) n = i[s], e[s] !== n && (r[s] || (t.fx.step[s] || !isNaN(parseFloat(n))) && (o[s] = n));
                                            return o;
                                        }(this.start, this.end), this;
                                    })), n.attr("class", a), h = h.map((function() {
                                ...
                                addClass: (i = t.fn.addClass, function(e, s, n, o) {
                                    return s ? t.effects.animateClass.call(this, {
                                        add: e
                                    }, s, n, o) : i.apply(this, arguments);
                                }),
                                removeClass: (s = t.fn.removeClass, function(e, i, n, o) {
                                    return arguments.length > 1 ? t.effects.animateClass.call(this, {
                                        remove: e
                                    }, i, n, o) : s.apply(this, arguments);
                                }),
                                toggleClass: (n = t.fn.toggleClass, function(e, i, s, o, r) {
                                    return "boolean" == typeof i || void 0 === i ? s ? t.effects.animateClass.call(this, i ? {
                                        add: e
                                    } : {
                                        remove: e
                                    }, s, o, r) : n.apply(this, arguments) : t.effects.animateClass.call(this, {
                                        toggle: e
                                    }, i, s, o);
                                }),
                            ...
                            function r(e) {
                                return !e || "number" == typeof e || !!t.fx.speeds[e] || "string" == typeof e && !t.effects.effect[e] || !!t.isFunction(e) || "object" == h(e) && !e.effect;
                            }
                            function a(t, e) {
                            ...
                            function(i) {
                                return !!t(i).data(v) || e(i);
                            })), !1 !== t.uiBackCompat && t.extend(t.effects, {
                                save: function(t, e) {
                                    for (var i = 0, s = e.length; s > i; i++) null !== e[i] && t.data(g + e[i], t[0].style[e[i]]);
                                },
                                restore: function(t, e) {
                                    for (var i, s = 0, n = e.length; n > s; s++) null !== e[s] && (i = t.data(g + e[s]), 
                                    t.css(e[s], i));
                                },
                                ...
                                effect: function() {
                                    function e(e) {
                                        ...
                                        var r = t(this);
                                        i.mode = c.shift(), !1 === t.uiBackCompat || n ? "none" === i.mode ? (r[h](), o()) : s.call(r[0], i, (function() {
                                            r.removeData(v), t.effects.cleanUp(r), "hide" === i.mode && r.hide(), o();
                                        })) : (r.is(":hidden") ? "hide" === h : "show" === h) ? (r[h](), o()) : s.call(r[0], i, o);
                                    }
                                    var i = o.apply(this, arguments), s = t.effects.effect[i.effect], n = s.mode, r = i.queue, a = r || "fx", l = i.complete, h = i.mode, c = [], u = function(e) {
                                        var i = t(this), s = t.effects.mode(i, h) || n;
                                        i.data(v, !0), c.push(s), n && ("show" === s || s === n && "hide" === s) && i.show(), 
                                        n && "none" === s || t.effects.saveStyle(i), t.isFunction(e) && e();
                                    };
                                    return t.fx.off || !s ? h ? this[h](i.duration, l) : this.each((function() {
                                        l && l.call(this);
                                    })) : !1 === r ? this.each(u).each(e) : this.queue(a, u).queue(a, e);
                                },
                                ...
                                toggle: (n = t.fn.toggle, function(t) {
                                    if (r(t) || "boolean" == typeof t) return n.apply(this, arguments);
                                    var e = o.apply(this, arguments);
                                ...
                                e.clipInit || (e.start = t(e.elem).cssClip(), "string" == typeof e.end && (e.end = a(e.end, e.elem)), 
                        ...
                        }(), d = {}, t.each([ "Quad", "Cubic", "Quart", "Quint", "Expo" ], (function(t, e) {
                            d[e] = function(e) {
                            ...
                            a.clip[s[o][0]] = a.clip[s[o][1]], "show" === e.mode && (n.cssClip(a.clip), l && l.css(t.effects.clipToBox(a)), 
                            a.clip = r), l && l.animate(t.effects.clipToBox(a), e.duration, e.easing), n.animate(a, {
                                queue: !1,
                                duration: e.duration,
                                easing: e.easing,
                                complete: i
                            ...
                            for (t.effects.createPlaceholder(r), o = r.css(m), u || (u = r["top" === m ? "outerHeight" : "outerWidth"]() / 3), 
                            h && ((n = {
                                opacity: 1
                            })[m] = o, r.css("opacity", 0).css(m, v ? -2 * u : 2 * u).animate(n, f, g)), l && (u /= Math.pow(2, d - 1)), 
                            (n = {})[m] = o; d > _; _++) (s = {})[m] = (v ? "-=" : "+=") + u, r.animate(s, f, g).animate(n, f, g), 
                            u = l ? 2 * u : u / 2;
                            l && ((s = {
                                opacity: 0
                            })[m] = (v ? "-=" : "+=") + u, r.animate(s, f, g)), r.queue(i), t.effects.unshift(r, b, p + 1);
                            ...
                            var s, n = t(this), o = e.mode, r = e.direction || "left", a = "up" === r || "down" === r ? "top" : "left", l = "up" === r || "left" === r ? "-=" : "+=", h = {
                                opacity: 0
                            };
                            t.effects.createPlaceholder(n), s = e.distance || n["top" === a ? "outerHeight" : "outerWidth"](!0) / 2, 
                            h[a] = l + s, "show" === o && (n.css(h), h[a] = ("+=" === l ? "-=" : "+=") + s, 
                            h.opacity = 1), n.animate(h, {
                                queue: !1,
                                duration: e.duration,
                                easing: e.easing,
                                complete: i
                            ...
                            var n, o, r, a, l, h, c = e.pieces ? Math.round(Math.sqrt(e.pieces)) : 3, u = c, d = t(this), p = "show" === e.mode, f = d.show().css("visibility", "hidden").offset(), g = Math.ceil(d.outerWidth() / u), m = Math.ceil(d.outerHeight() / c), v = [];
                            for (n = 0; c > n; n++) for (a = f.top + n * m, h = n - (c - 1) / 2, o = 0; u > o; o++) r = f.left + o * g, 
                            l = o - (u - 1) / 2, d.clone().appendTo("body").wrap("<div></div>").css({
                                position: "absolute",
                                visibility: "visible",
                                left: -o * g,
                                top: -n * m
                            ...
                            var s = t(this), n = e.mode, o = e.size || 15, r = /([0-9]+)%/.exec(o), a = e.horizFirst ? [ "right", "bottom" ] : [ "bottom", "right" ], l = e.duration / 2, h = t.effects.createPlaceholder(s), c = s.cssClip(), u = {
                                clip: t.extend({}, c)
                            }, d = {
                                clip: t.extend({}, c)
                            }, p = [ c[a[0]], c[a[1]] ], f = s.queue().length;
                            r && (o = parseInt(r[1], 10) / 100 * p["hide" === n ? 0 : 1]), u.clip[a[0]] = o, 
                            d.clip[a[0]] = o, d.clip[a[1]] = 0, "show" === n && (s.cssClip(d.clip), h && h.css(t.effects.clipToBox(d)), 
                            d.clip = c), s.queue((function(i) {
                            ...
                            }, ("box" === d || "both" === d) && (n.from.y !== n.to.y && (v = t.effects.setTransition(r, l, n.from.y, v), 
                            _ = t.effects.setTransition(r, l, n.to.y, _)), n.from.x !== n.to.x && (v = t.effects.setTransition(r, h, n.from.x, v), 
                            _ = t.effects.setTransition(r, h, n.to.x, _))), ("content" === d || "both" === d) && n.from.y !== n.to.y && (v = t.effects.setTransition(r, a, n.from.y, v), 
                            _ = t.effects.setTransition(r, a, n.to.y, _)), p && (s = t.effects.getBaseline(p, m), 
                            ...
                            r.css(v), ("content" === d || "both" === d) && (l = l.concat([ "marginTop", "marginBottom" ]).concat(a), 
                            h = h.concat([ "marginLeft", "marginRight" ]), r.find("*[width]").each((function() {
                                ...
                                n.from.y !== n.to.y && (o = t.effects.setTransition(i, l, n.from.y, o), r = t.effects.setTransition(i, l, n.to.y, r)), 
                                n.from.x !== n.to.x && (o = t.effects.setTransition(i, h, n.from.x, o), r = t.effects.setTransition(i, h, n.to.x, r)), 
                                u && t.effects.saveStyle(i), i.css(o), i.animate(r, e.duration, e.easing, (function() {
                                ...
                                complete: function() {
                                    var e = r.offset();
                                    0 === _.opacity && r.css("opacity", v.opacity), u || (r.css("position", "static" === f ? "relative" : f).offset(e), 
                                    t.effects.saveStyle(r)), i();
                                }
                            });
                        })), t.effects.define("scale", (function(e, i) {
                            var s = t(this), n = e.mode, o = parseInt(e.percent, 10) || (0 === parseInt(e.percent, 10) || "effect" !== n ? 0 : 100), r = t.extend(!0, {
                            ...
                            var s = t(this), n = e.mode, o = "show" === n, r = 2 * (e.times || 5) + (o || "hide" === n ? 1 : 0), a = e.duration / r, l = 0, h = 1, c = s.queue().length;
                            for ((o || !s.is(":visible")) && (s.css("opacity", 0).show(), l = 1); r > h; h++) s.animate({
                                opacity: l
                            }, a, e.easing), l = 1 - l;
                            s.animate({
                                opacity: l
                            }, a, e.easing), s.queue(i), t.effects.unshift(s, c, r + 1);
                            ...
                            for (t.effects.createPlaceholder(n), d[c] = (u ? "-=" : "+=") + r, p[c] = (u ? "+=" : "-=") + 2 * r, 
                            f[c] = (u ? "-=" : "+=") + 2 * r, n.animate(d, h, e.easing); a > s; s++) n.animate(p, h, e.easing).animate(f, h, e.easing);
                            ...
                            var s, n, o = t(this), r = {
                                ...
                                left: [ "right", "left" ],
                                right: [ "left", "right" ]
                            }, a = e.mode, l = e.direction || "left", h = "up" === l || "down" === l ? "top" : "left", c = e.distance || o["top" === h ? "outerHeight" : "outerWidth"](!0), u = {};
                            t.effects.createPlaceholder(o), s = o.cssClip(), n = o.position()[h], u[h] = ("up" === l || "left" === l ? -1 : 1) * c + n, 
                            u.clip = o.cssClip(), u.clip[r[l][1]] = u.clip[r[l][0]], "show" === a && (o.cssClip(u.clip), 
                            o.css(h, u[h]), u.clip = s, u[h] = n), o.animate(u, {
                                queue: !1,
                                duration: e.duration,
                                easing: e.easing,
                                complete: i
                            ...
                            return "area" === l ? (n = (s = e.parentNode).name, !!e.href && !!n && "map" === s.nodeName.toLowerCase() && (o = t("img[usemap='#" + n + "']")).length > 0 && o.is(":visible")) : (/^(input|select|textarea|button|object)$/.test(l) ? (r = !e.disabled) && (a = t(e).closest("fieldset")[0]) && (r = !a.disabled) : r = "a" === l && e.href || i, 
                            ...
                            _eventHandler: function(e) {
                                ...
                                e.preventDefault(), a && !n.collapsible || !1 === this._trigger("beforeActivate", e, u) || (n.active = !l && this.headers.index(r), 
                                this.active = a ? t() : r, this._toggle(u), this._removeClass(o, "ui-accordion-header-active", "ui-state-active"), 
                                ...
                                n.icons && (s = r.children(".ui-accordion-header-icon"), this._removeClass(s, null, n.icons.header)._addClass(s, null, n.icons.activeHeader)), 
                            ...
                            _keydown: function(e) {
                                ...
                                switch (e.keyCode) {
                                  ...
                                  default:
                                    r = !1, s = this.previousFilter || "", o = !1, n = e.keyCode >= 96 && 105 >= e.keyCode ? "" + (e.keyCode - 96) : String.fromCharCode(e.keyCode), 
                            ...
                            refresh: function() {
                                ...
                                i = a.filter(":not(.ui-menu)").hide().attr({
                                    ...
                                    o._addClass(s, "ui-menu-icon", "ui-icon " + r), i.attr("aria-haspopup", "true").prepend(s), 
                                    ...
                                    tabIndex: -1,
                                    role: this._itemRole()
                                }), this._addClass(s, "ui-menu-item")._addClass(n, "ui-menu-item-wrapper"), e.filter(".ui-state-disabled").attr("aria-disabled", "true"), 
                            ...
                            _scrollIntoView: function(e) {
                                ...
                                o = this.activeMenu.scrollTop(), r = this.activeMenu.height(), a = e.outerHeight(), 
                            ...
                            _create: function() {
                                ...
                                this.isMultiLine = o || !r && this._isContentEditable(this.element), this.valueMethod = this.element[o || r ? "val" : "text"], 
                        ...
                        t.widget("ui.controlgroup", {
                                ...
                                t.each(this.options.items, (function(s, n) {
                                    ...
                                    return n ? "controlgroupLabel" === s ? ((o = e.element.find(n)).each((function() {
                                        ...
                                        if ("button" !== s || !n.parent(".ui-spinner").length) {
                                            o || (o = n[s]()[s]("instance")), o && (a.classes = e._resolveClassesValues(a.classes, o)), 
                                            n[s](a);
                                            var l = n[s]("widget");
                            ...
                            _resolveClassesValues: function(e, i) {
                                ...
                                return t.each(e, (function(n) {
                                    ...
                                    o = t.trim(o.replace(y, "")), s[n] = (o + " " + e[n]).replace(/\s+/g, " ");
                                })), s;
                            },
                            _setOption: function(t, e) {
                            ...
                            _updateIcon: function(e, i) {
                                ...
                                s && this._addClass(this.icon, null, i), this._attachIcon(n), "top" === n || "bottom" === n ? (this._addClass(this.icon, null, "ui-widget-icon-block"), 
                        ...
                        }), t.fn.button = (b = t.fn.button, function() {
                            return !this.length || this.length && "INPUT" !== this[0].tagName || this.length && "INPUT" === this[0].tagName && "checkbox" !== this.attr("type") && "radio" !== this.attr("type") ? b.apply(this, arguments) : (t.ui.checkboxradio || t.error("Checkboxradio widget missing"), 
                            0 === arguments.length ? this.checkboxradio({
                                icon: !1
                            }) : this.checkboxradio.apply(this, arguments));
                        }), t.fn.buttonset = function() {
                            return t.ui.controlgroup || t.error("Controlgroup widget missing"), "option" === arguments[0] && "items" === arguments[1] && arguments[2] ? this.controlgroup.apply(this, [ arguments[0], "items.button", arguments[2] ]) : "option" === arguments[0] && "items" === arguments[1] ? this.controlgroup.apply(this, [ arguments[0], "items.button" ]) : ("object" == h(arguments[0]) && arguments[0].items && (arguments[0].items = {
                            ...
                            _attachments: function(e, i) {
                                ...
                                i.append && i.append.remove(), r && (i.append = t("<span class='" + this._appendClass + "'>" + r + "</span>"), 
                            ...
                            _dialogDatepicker: function(e, i, s, o, r) {
                                ...
                                return d || (this.uuid += 1, a = "dp" + this.uuid, this._dialogInput = t("<input type='text' id='" + a + "' style='position: absolute; top: -100px; width: 0px;'/>"), 
                                ...
                                n(d.settings, o || {}), i = i && i.constructor === Date ? this._formatDate(d, i) : i, 
                            ...
                            _optionDatepicker: function(e, i, s) {
                                ...
                                "string" == typeof i && ((o = {})[i] = s), void (h && (this._curInst === h && this._hideDatepicker(), 
                                r = this._getDateDatepicker(e, !0), a = this._getMinMaxDate(h, "min"), l = this._getMinMaxDate(h, "max"), 
                                n(h.settings, o), null !== a && void 0 !== o.dateFormat && void 0 === o.minDate && (h.settings.minDate = this._formatDate(h, a)), 
                                ...
                                this._attachments(t(e), h), this._autoSize(h), this._setDate(h, r), this._updateAlternate(h), 
                            ...
                            _doKeyDown: function(e) {
                                ...
                                if (o._keyEvent = !0, t.datepicker._datepickerShowing) switch (e.keyCode) {
                                  ...
                                  case 37:
                                    ...
                                    r = e.ctrlKey || e.metaKey, e.originalEvent.altKey && t.datepicker._adjustDate(e.target, e.ctrlKey ? -t.datepicker._get(o, "stepBigMonths") : -t.datepicker._get(o, "stepMonths"), "M");
                                    break;
                            ...
                            _showDatepicker: function(e) {
                                ...
                                !1 !== (o = (s = t.datepicker._get(i, "beforeShow")) ? s.apply(e, [ e, i ]) : {}) && (n(i.settings, o), 
                                ...
                                t.datepicker._pos[1] += e.offsetHeight), r = !1, t(e).parents().each((function() {
                                    ...
                                    left: a.left + "px",
                                    top: a.top + "px"
                                }), i.inline || (l = t.datepicker._get(i, "showAnim"), h = t.datepicker._get(i, "duration"), 
                                i.dpDiv.css("z-index", function(t) {
                                    ...
                                    return 0;
                                }(t(e)) + 1), t.datepicker._datepickerShowing = !0, t.effects && t.effects.effect[l] ? i.dpDiv.show(l, t.datepicker._get(i, "showOptions"), h) : i.dpDiv[l || "show"](l ? h : null), 
                                t.datepicker._shouldFocusInput(i) && i.input.trigger("focus"), t.datepicker._curInst = i)));
                            },
                            ...
                            _checkOffset: function(e, i, s) {
                                ...
                                return i.left -= this._get(e, "isRTL") ? n - r : 0, i.left -= s && i.left === e.input.offset().left ? t(document).scrollLeft() : 0, 
                                i.top -= s && i.top === e.input.offset().top + a ? t(document).scrollTop() : 0, 
                                i.left -= Math.min(i.left, i.left + n > l && l > n ? Math.abs(i.left + n - l) : 0), 
                                i.top -= Math.min(i.top, i.top + o > h && h > o ? Math.abs(o + a) : 0), i;
                            },
                            _findPos: function(e) {
                            ...
                            _hideDatepicker: function(e) {
                                ...
                                i || n(), this._datepickerShowing = !1, (o = this._get(r, "onClose")) && o.apply(r.input ? r.input[0] : null, [ r.input ? r.input.val() : "", r ]), 
                            ...
                            _selectDay: function(e, i, s, n) {
                                var o, r = t(e);
                                t(n).hasClass(this._unselectableClass) || this._isDisabledDatepicker(r[0]) || ((o = this._getInst(r[0])).selectedDay = o.currentDay = t("a", n).html(), 
                            ...
                            _selectDate: function(e, i) {
                                ...
                                "object" != h(o.input[0]) && o.input.trigger("focus"), this._lastInput = null);
                            },
                            ...
                            parseDate: function(e, i, s) {
                                ...
                                if ("" == (i = "object" == h(i) ? "" + i : i + "")) return null;
                                var n, o, r, a, l = 0, c = (s ? s.shortYearCutoff : null) || this._defaults.shortYearCutoff, u = "string" != typeof c ? c : (new Date).getFullYear() % 100 + parseInt(c, 10), d = (s ? s.dayNamesShort : null) || this._defaults.dayNamesShort, p = (s ? s.dayNames : null) || this._defaults.dayNames, f = (s ? s.monthNamesShort : null) || this._defaults.monthNamesShort, g = (s ? s.monthNames : null) || this._defaults.monthNames, m = -1, v = -1, _ = -1, b = -1, y = !1, w = function(t) {
                                    var i = e.length > n + 1 && e.charAt(n + 1) === t;
                                    return i && n++, i;
                                }, x = function(t) {
                                    var e = w(t), s = "@" === t ? 14 : "!" === t ? 20 : "y" === t && e ? 4 : "o" === t ? 3 : 2, n = RegExp("^\\d{" + ("y" === t ? s : 1) + "," + s + "}"), o = i.substring(l).match(n);
                                ...
                                for (n = 0; e.length > n; n++) if (y) "'" !== e.charAt(n) || w("'") ? C() : y = !1; else switch (e.charAt(n)) {
                                  case "d":
                                    _ = x("d");
                                    break;
                                  ...
                                  case "@":
                                    m = (a = new Date(x("@"))).getFullYear(), v = a.getMonth() + 1, _ = a.getDate();
                                    break;

                                  case "!":
                                    m = (a = new Date((x("!") - this._ticksTo1970) / 1e4)).getFullYear(), v = a.getMonth() + 1, 
                                    _ = a.getDate();
                                    break;
                                ...
                                b > -1) for (v = 1, _ = b; !((o = this._getDaysInMonth(m, v - 1)) >= _); ) v++, 
                                _ -= o;
                                if ((a = this._daylightSavingAdjust(new Date(m, v - 1, _))).getFullYear() !== m || a.getMonth() + 1 !== v || a.getDate() !== _) throw "Invalid date";
                                return a;
                            },
                            ATOM: "yy-mm-dd",
                            COOKIE: "D, dd M yy",
                            ...
                            _determineDate: function(e, i, s) {
                                var r = null == i || "" === i ? s : "string" == typeof i ? function(i) {
                                    try {
                                ...
                                return (r = r && "Invalid Date" == "" + r ? s : r) && (r.setHours(0), r.setMinutes(0), 
                            ...
                            _setDate: function(t, e, i) {
                                var s = t.selectedMonth, n = t.selectedYear, o = this._restrictMinMax(t, this._determineDate(t, e, new Date));
                                t.selectedDay = t.currentDay = o.getDate(), t.drawMonth = t.selectedMonth = t.currentMonth = o.getMonth(), 
                                t.drawYear = t.selectedYear = t.currentYear = o.getFullYear(), s === t.selectedMonth && n === t.selectedYear || i || this._notifyChange(t), 
                                this._adjustInstDate(t), t.input && t.input.val(e ? this._formatDate(t) : "");
                            },
                            _getDate: function(t) {
                            ...
                            _generateHTML: function(t) {
                                var e, i, s, n, o, r, a, l, h, c, u, d, p, f, g, m, v, _, b, y, w, x, k, C, D, T, I, S, P, M, A, E, H, N, O, z, W, L, F, R = new Date, j = this._daylightSavingAdjust(new Date(R.getFullYear(), R.getMonth(), R.getDate())), q = this._get(t, "isRTL"), B = this._get(t, "showButtonPanel"), Y = this._get(t, "hideIfNoPrevNext"), $ = this._get(t, "navigationAsDateFormat"), U = this._getNumberOfMonths(t), K = this._get(t, "showCurrentAtPos"), V = this._get(t, "stepMonths"), X = 1 !== U[0] || 1 !== U[1], G = this._daylightSavingAdjust(t.currentDay ? new Date(t.currentYear, t.currentMonth, t.currentDay) : new Date(9999, 9, 9)), Q = this._getMinMaxDate(t, "min"), J = this._getMinMaxDate(t, "max"), Z = t.drawMonth - K, tt = t.drawYear;
                                if (0 > Z && (Z += 12, tt--), J) for (e = this._daylightSavingAdjust(new Date(J.getFullYear(), J.getMonth() - U[0] * U[1] + 1, J.getDate())), 
                                e = Q && Q > e ? Q : e; this._daylightSavingAdjust(new Date(tt, Z, 1)) > e; ) 0 > --Z && (Z = 11, 
                                tt--);
                                for (t.drawMonth = Z, t.drawYear = tt, i = this._get(t, "prevText"), i = $ ? this.formatDate(i, this._daylightSavingAdjust(new Date(tt, Z - V, 1)), this._getFormatConfig(t)) : i, 
                                s = this._canAdjustMonth(t, -1, tt, Z) ? "<a class='ui-datepicker-prev ui-corner-all' data-handler='prev' data-event='click' title='" + i + "'><span class='ui-icon ui-icon-circle-triangle-" + (q ? "e" : "w") + "'>" + i + "</span></a>" : Y ? "" : "<a class='ui-datepicker-prev ui-corner-all ui-state-disabled' title='" + i + "'><span class='ui-icon ui-icon-circle-triangle-" + (q ? "e" : "w") + "'>" + i + "</span></a>", 
                                n = this._get(t, "nextText"), n = $ ? this.formatDate(n, this._daylightSavingAdjust(new Date(tt, Z + V, 1)), this._getFormatConfig(t)) : n, 
                                o = this._canAdjustMonth(t, 1, tt, Z) ? "<a class='ui-datepicker-next ui-corner-all' data-handler='next' data-event='click' title='" + n + "'><span class='ui-icon ui-icon-circle-triangle-" + (q ? "w" : "e") + "'>" + n + "</span></a>" : Y ? "" : "<a class='ui-datepicker-next ui-corner-all ui-state-disabled' title='" + n + "'><span class='ui-icon ui-icon-circle-triangle-" + (q ? "w" : "e") + "'>" + n + "</span></a>", 
                                r = this._get(t, "currentText"), a = this._get(t, "gotoCurrent") && t.currentDay ? G : j, 
                                r = $ ? this.formatDate(r, a, this._getFormatConfig(t)) : r, l = t.inline ? "" : "<button type='button' class='ui-datepicker-close ui-state-default ui-priority-primary ui-corner-all' data-handler='hide' data-event='click'>" + this._get(t, "closeText") + "</button>", 
                                ...
                                _ = this._get(t, "selectOtherMonths"), b = this._getDefaultDate(t), y = "", x = 0; U[0] > x; x++) {
                                    for (k = "", this.maxRows = 4, C = 0; U[1] > C; C++) {
                                        ...
                                        for (I += "<div class='ui-datepicker-header ui-widget-header ui-helper-clearfix" + T + "'>" + (/all|left/.test(T) && 0 === x ? q ? o : s : "") + (/all|right/.test(T) && 0 === x ? q ? s : o : "") + this._generateMonthYearHeader(t, Z, tt, Q, J, x > 0 || C > 0, f, g) + "</div><table class='ui-datepicker-calendar'><thead><tr>", 
                                        S = u ? "<th class='ui-datepicker-week-col'>" + this._get(t, "weekHeader") + "</th>" : "", 
                                        w = 0; 7 > w; w++) S += "<th scope='col'" + ((w + c + 6) % 7 >= 5 ? " class='ui-datepicker-week-end'" : "") + "><span title='" + d[P = (w + c) % 7] + "'>" + p[P] + "</span></th>";
                                        for (I += S + "</tr></thead><tbody>", M = this._getDaysInMonth(tt, Z), tt === t.selectedYear && Z === t.selectedMonth && (t.selectedDay = Math.min(t.selectedDay, M)), 
                                        E = Math.ceil(((A = (this._getFirstDayOfMonth(tt, Z) - c + 7) % 7) + M) / 7), H = X && this.maxRows > E ? this.maxRows : E, 
                                        this.maxRows = H, N = this._daylightSavingAdjust(new Date(tt, Z, 1 - A)), O = 0; H > O; O++) {
                                            for (I += "<tr>", z = u ? "<td class='ui-datepicker-week-col'>" + this._get(t, "calculateWeek")(N) + "</td>" : "", 
                                            w = 0; 7 > w; w++) W = m ? m.apply(t.input ? t.input[0] : null, [ N ]) : [ !0, "" ], 
                                            F = (L = N.getMonth() !== Z) && !_ || !W[0] || Q && Q > N || J && N > J, z += "<td class='" + ((w + c + 6) % 7 >= 5 ? " ui-datepicker-week-end" : "") + (L ? " ui-datepicker-other-month" : "") + (N.getTime() === D.getTime() && Z === t.selectedMonth && t._keyEvent || b.getTime() === N.getTime() && b.getTime() === D.getTime() ? " " + this._dayOverClass : "") + (F ? " " + this._unselectableClass + " ui-state-disabled" : "") + (L && !v ? "" : " " + W[1] + (N.getTime() === G.getTime() ? " " + this._currentClass : "") + (N.getTime() === j.getTime() ? " ui-datepicker-today" : "")) + "'" + (L && !v || !W[2] ? "" : " title='" + W[2].replace(/'/g, "&#39;") + "'") + (F ? "" : " data-handler='selectDay' data-event='click' data-month='" + N.getMonth() + "' data-year='" + N.getFullYear() + "'") + ">" + (L && !v ? "&#xa0;" : F ? "<span class='ui-state-default'>" + N.getDate() + "</span>" : "<a class='ui-state-default" + (N.getTime() === j.getTime() ? " ui-state-highlight" : "") + (N.getTime() === G.getTime() ? " ui-state-active" : "") + (L ? " ui-priority-secondary" : "") + "' href='#'>" + N.getDate() + "</a>") + "</td>", 
                            ...
                            _generateMonthYearHeader: function(t, e, i, s, n, o, r, a) {
                                ...
                                if (o || !m) y += "<span class='ui-datepicker-month'>" + r[e] + "</span>"; else {
                                    ...
                                    c = 0; 12 > c; c++) (!l || c >= s.getMonth()) && (!h || n.getMonth() >= c) && (y += "<option value='" + c + "'" + (c === e ? " selected='selected'" : "") + ">" + a[c] + "</option>");
                                    y += "</select>";
                                }
                                ...
                                o || !v) b += "<span class='ui-datepicker-year'>" + i + "</span>"; else {
                                    for (u = this._get(t, "yearRange").split(":"), d = (new Date).getFullYear(), g = Math.max(f = (p = function(t) {
                                        ...
                                        return isNaN(e) ? d : e;
                                    })(u[0]), p(u[1] || "")), f = s ? Math.max(f, s.getFullYear()) : f, g = n ? Math.min(g, n.getFullYear()) : g, 
                            ...
                            _isInRange: function(t, e) {
                                ...
                                return l && (i = l.split(":"), s = (new Date).getFullYear(), r = parseInt(i[0], 10), 
                                a = parseInt(i[1], 10), i[0].match(/[+\-].*/) && (r += s), i[1].match(/[+\-].*/) && (a += s)), 
                            ...
                            _formatDate: function(t, e, i, s) {
                                ...
                                var n = e ? "object" == h(e) ? e : this._daylightSavingAdjust(new Date(s, i, e)) : this._daylightSavingAdjust(new Date(t.currentYear, t.currentMonth, t.currentDay));
                        ...
                        t(document).on("mouseup", (function() {
                            ...
                            _mouseUp: function(e) {
                                ...
                                delete this._mouseDelayTimer), this.ignoreMissingWhich = !1, w = !1, e.preventDefault();
                            },
                            ...
                            _generatePosition: function(t, e) {
                                ...
                                t.pageY - this.offset.click.top > i[3] && (h = i[3] + this.offset.click.top)), r.grid && (n = r.grid[1] ? this.originalPageY + Math.round((h - this.originalPageY) / r.grid[1]) * r.grid[1] : this.originalPageY, 
                            ...
                            drag: function(e, i, s) {
                                ...
                                n.axis && "y" === n.axis || (s.overflowOffset.left + r.offsetWidth - e.pageX < n.scrollSensitivity ? r.scrollLeft = o = r.scrollLeft + n.scrollSpeed : e.pageX - s.overflowOffset.left < n.scrollSensitivity && (r.scrollLeft = o = r.scrollLeft - n.scrollSpeed))) : (n.axis && "x" === n.axis || (e.pageY - t(a).scrollTop() < n.scrollSensitivity ? o = t(a).scrollTop(t(a).scrollTop() - n.scrollSpeed) : t(window).height() - (e.pageY - t(a).scrollTop()) < n.scrollSensitivity && (o = t(a).scrollTop(t(a).scrollTop() + n.scrollSpeed))), 
                                n.axis && "y" === n.axis || (e.pageX - t(a).scrollLeft() < n.scrollSensitivity ? o = t(a).scrollLeft(t(a).scrollLeft() - n.scrollSpeed) : t(window).width() - (e.pageX - t(a).scrollLeft()) < n.scrollSensitivity && (o = t(a).scrollLeft(t(a).scrollLeft() + n.scrollSpeed)))), 
                            ...
                            drag: function(e, i, s) {
                                ...
                                u = (c = s.snapElements[d].top - s.margins.top) + s.snapElements[d].height, l - g > v || m > h + g || c - g > b || _ > u + g || !t.contains(s.snapElements[d].item.ownerDocument, s.snapElements[d].item) ? (s.snapElements[d].snapping && s.options.snap.release && s.options.snap.release.call(s.element, e, t.extend(s._uiHash(), {
                                    snapItem: s.snapElements[d].item
                                })), s.snapElements[d].snapping = !1) : ("inner" !== f.snapMode && (n = g >= Math.abs(c - b), 
                                o = g >= Math.abs(u - _), r = g >= Math.abs(l - v), a = g >= Math.abs(h - m), n && (i.position.top = s._convertPositionTo("relative", {
                                    ...
                                    top: 0,
                                    left: h
                                }).left)), p = n || o || r || a, "outer" !== f.snapMode && (n = g >= Math.abs(c - _), 
                                o = g >= Math.abs(u - b), r = g >= Math.abs(l - m), a = g >= Math.abs(h - v), n && (i.position.top = s._convertPositionTo("relative", {
                                    top: c,
                                    left: 0
                                }).top), o && (i.position.top = s._convertPositionTo("relative", {
                            ...
                            _mouseDrag: function(e) {
                                ...
                                return this._updatePrevProperties(), !!l && (i = l.apply(this, [ e, r, a ]), this._updateVirtualBoundaries(e.shiftKey), 
                            ...
                            _mouseStop: function(e) {
                                ...
                                h.animate || this.element.css(t.extend(r, {
                                    top: l,
                                    left: a
                                })), this.helper.height(this.size.height), this.helper.width(this.size.width), this._helper && !h.animate && this._proportionallyResize()), 
                            ...
                            _respectSize: function(t) {
                                ...
                                return o && (t.width = e.minWidth), r && (t.height = e.minHeight), s && (t.width = e.maxWidth), 
                                n && (t.height = e.maxHeight), o && h && (t.left = a - e.minWidth), s && h && (t.left = a - e.maxWidth), 
                                r && c && (t.top = l - e.minHeight), n && c && (t.top = l - e.maxHeight), t.width || t.height || t.left || !t.top ? t.width || t.height || t.top || !t.left || (t.left = null) : t.top = null, 
                                t;
                            },
                            ...
                            start: function() {
                                ...
                                r = l._hasScroll(d, "left") ? d.scrollWidth : o, a = l._hasScroll(d) ? d.scrollHeight : n, 
                                l.parentData = {
                                    element: d,
                                    left: s.left,
                                    top: s.top,
                            ...
                            resize: function(e) {
                                ...
                                d[0] !== document && /static/.test(d.css("position")) && (u = l), h.left < (r._helper ? l.left : 0) && (r.size.width = r.size.width + (r._helper ? r.position.left - l.left : r.position.left - u.left), 
                                c && (r.size.height = r.size.width / r.aspectRatio, p = !1), r.position.left = a.helper ? l.left : 0), 
                                h.top < (r._helper ? l.top : 0) && (r.size.height = r.size.height + (r._helper ? r.position.top - l.top : r.position.top), 
                                c && (r.size.width = r.size.height * r.aspectRatio, p = !1), r.position.top = r._helper ? l.top : 0), 
                                n = r.containerElement.get(0) === r.element.parent().get(0), o = /relative|absolute/.test(r.containerElement.css("position")), 
                                n && o ? (r.offset.left = r.parentData.left + r.position.left, r.offset.top = r.parentData.top + r.position.top) : (r.offset.left = r.element.offset().left, 
                                r.offset.top = r.element.offset().top), i = Math.abs(r.sizeDiff.width + (r._helper ? r.offset.left - u.left : r.offset.left - l.left)), 
                                s = Math.abs(r.sizeDiff.height + (r._helper ? r.offset.top - u.top : r.offset.top - l.top)), 
                                i + r.size.width >= r.parentData.width && (r.size.width = r.parentData.width - i, 
                                c && (r.size.height = r.size.width / r.aspectRatio, p = !1)), s + r.size.height >= r.parentData.height && (r.size.height = r.parentData.height - s, 
                                c && (r.size.width = r.size.height * r.aspectRatio, p = !1)), p || (r.position.left = r.prevPosition.left, 
                                r.position.top = r.prevPosition.top, r.size.width = r.prevSize.width, r.size.height = r.prevSize.height);
                            },
                            stop: function() {
                            ...
                            resize: function() {
                                var e, i = t(this).resizable("instance"), s = i.options, n = i.size, o = i.originalSize, r = i.originalPosition, a = i.axis, l = "number" == typeof s.grid ? [ s.grid, s.grid ] : s.grid, h = l[0] || 1, c = l[1] || 1, u = Math.round((n.width - o.width) / h) * h, d = Math.round((n.height - o.height) / c) * c, p = o.width + u, f = o.height + d, g = s.maxWidth && p > s.maxWidth, m = s.maxHeight && f > s.maxHeight, v = s.minWidth && s.minWidth > p, _ = s.minHeight && s.minHeight > f;
                                s.grid = l, v && (p += h), _ && (f += c), g && (p -= h), m && (f -= c), /^(se|s|e)$/.test(a) ? (i.size.width = p, 
                                i.size.height = f) : /^(ne)$/.test(a) ? (i.size.width = p, i.size.height = f, i.position.top = r.top - d) : /^(sw)$/.test(a) ? (i.size.width = p, 
                                i.size.height = f, i.position.left = r.left - u) : ((0 >= f - c || 0 >= p - h) && (e = i._getPaddingPlusBorderDimensions(this)), 
                                f - c > 0 ? (i.size.height = f, i.position.top = r.top - d) : (f = c - e.height, 
                                i.size.height = f, i.position.top = r.top + o.height - f), p - h > 0 ? (i.size.width = p, 
                                i.position.left = r.left - u) : (p = h - e.width, i.size.width = p, i.position.left = r.left + o.width - p));
                            }
                            ...
                            _drop: function(e, i) {
                                ...
                                return !!s && (s.currentItem || s.element)[0] !== this.element[0] && (this.element.find(":data(ui-droppable)").not(".ui-draggable-dragging").each((function() {
                                    ...
                                    return i.options.greedy && !i.options.disabled && i.options.scope === s.options.scope && i.accept.call(i.element[0], s.currentItem || s.element) && k(s, t.extend(i, {
                        ...
                        var x, k = t.ui.intersect = function() {
                            function t(t, e, i) {
                                return t >= e && e + i > t;
                            }
                        ...
                        t.ui.ddmanager = {
                            ...
                            prepareOffsets: function(e, i) {
                                ...
                                t: for (s = 0; o.length > s; s++) if (!(o[s].options.disabled || e && !o[s].accept.call(o[s].element[0], e.currentItem || e.element))) {
                                    ...
                                    o[s].visible = "none" !== o[s].element.css("display"), o[s].visible && ("mousedown" === r && o[s]._activate.call(o[s], i), 
                            ...
                            drop: function(e, i) {
                                ...
                                return t.each((t.ui.ddmanager.droppables[e.options.scope] || []).slice(), (function() {
                                    this.options && (!this.options.disabled && this.visible && k(e, this, this.options.tolerance, i) && (s = this._drop.call(this, i) || s), 
                            ...
                            drag: function(e, i) {
                                e.options.refreshPositions && t.ui.ddmanager.prepareOffsets(e, i), t.each(t.ui.ddmanager.droppables[e.options.scope] || [], (function() {
                                    if (!this.options.disabled && !this.greedyChild && this.visible) {
                                        var s, n, o, r = k(e, this, this.options.tolerance, i), a = !r && this.isover ? "isout" : r && !this.isover ? "isover" : null;
                                        a && (this.options.greedy && (n = this.options.scope, (o = this.element.parents(":data(ui-droppable)").filter((function() {
                                            return t(this).droppable("instance").options.scope === n;
                                        }))).length && ((s = t(o[0]).droppable("instance")).greedyChild = "isover" === a)), 
                                        s && "isover" === a && (s.isover = !1, s.isout = !0, s._out.call(s, i)), this[a] = !0, 
                            ...
                            _mouseDrag: function(e) {
                                if (this.dragged = !0, !this.options.disabled) {
                                    ...
                                    return o > a && (i = a, a = o, o = i), r > l && (i = l, l = r, r = i), this.helper.css({
                                        ...
                                        c.top = i.top + s.elementPos.top, c.bottom = i.bottom + s.elementPos.top, "touch" === n.tolerance ? h = !(c.left > a || o > c.right || c.top > l || r > c.bottom) : "fit" === n.tolerance && (h = c.left > o && a > c.right && c.top > r && l > c.bottom), 
                            ...
                            _renderMenu: function(e, i) {
                                ...
                                t.each(i, (function(i, o) {
                                    ...
                                    o.optgroup !== n && (r = t("<li>", {
                                        text: o.optgroup
                                    }), s._addClass(r, "ui-selectmenu-optgroup", "ui-menu-divider" + (o.element.parent("optgroup").prop("disabled") ? " ui-state-disabled" : "")), 
                                    r.appendTo(e), n = o.optgroup), s._renderItemData(e, o);
                                }));
                            },
                            _renderItemData: function(t, e) {
                            ...
                            _createHandles: function() {
                                ...
                                n = n.slice(0, i)), e = n.length; i > e; e++) o.push("<span tabindex='0'></span>");
                                this.handles = n.add(t(o.join("")).appendTo(this.element)), this._addClass(this.handles, "ui-slider-handle", "ui-state-default"), 
                            ...
                            _mouseCapture: function(e) {
                                ...
                                this.handles.each((function(e) {
                                    ...
                                    o = t(this), r = e);
                                })), !1 !== this._start(e, r) && (this._mouseSliding = !0, this._handleIndex = r, 
                                this._addClass(o, null, "ui-state-active"), o.trigger("focus"), a = o.offset(), 
                            ...
                            _refreshValue: function() {
                                ...
                                this._hasMultipleValues() ? this.handles.each((function(s) {
                                    i = (l.values(s) - l._valueMin()) / (l._valueMax() - l._valueMin()) * 100, c["horizontal" === l.orientation ? "left" : "bottom"] = i + "%", 
                                    t(this).stop(1, 1)[h ? "animate" : "css"](c, a.animate), !0 === l.options.range && ("horizontal" === l.orientation ? (0 === s && l.range.stop(1, 1)[h ? "animate" : "css"]({
                                        left: i + "%"
                                ...
                                })) : (s = this.value(), n = this._valueMin(), i = (o = this._valueMax()) !== n ? (s - n) / (o - n) * 100 : 0, 
                            ...
                            _mouseStop: function(e, i) {
                                if (e) {
                                    ...
                                    this.options.revert) {
                                        ...
                                        o && "y" !== o || (r.top = n.top - this.offset.parent.top - this.margins.top + (this.offsetParent[0] === this.document[0].body ? 0 : this.offsetParent[0].scrollTop)), 
                            ...
                            _intersectsWith: function(t) {
                                var e = this.positionAbs.left, i = e + this.helperProportions.width, s = this.positionAbs.top, n = s + this.helperProportions.height, o = t.left, r = o + t.width, a = t.top, l = a + t.height, h = this.offset.click.top, c = this.offset.click.left, u = "x" === this.options.axis || s + h > a && l > s + h, d = "y" === this.options.axis || e + c > o && r > e + c;
                                return "pointer" === this.options.tolerance || this.options.forcePointerForContainers || "pointer" !== this.options.tolerance && this.helperProportions[this.floating ? "width" : "height"] > t[this.floating ? "width" : "height"] ? u && d : e + this.helperProportions.width / 2 > o && r > i - this.helperProportions.width / 2 && s + this.helperProportions.height / 2 > a && l > n - this.helperProportions.height / 2;
                            },
                            ...
                            _refreshItems: function(e) {
                                ...
                                var i, s, n, o, r, a, l, h, c = this.items, u = [ [ t.isFunction(this.options.items) ? this.options.items.call(this.element[0], e, {
                                    item: this.currentItem
                                ...
                                for (i = u.length - 1; i >= 0; i--) for (r = u[i][1], s = 0, h = (a = u[i][0]).length; h > s; s++) (l = t(a[s])).data(this.widgetName + "-item", r), 
                                c.push({
                                    item: l,
                                    instance: r,
                                    width: 0,
                            ...
                            _contactContainers: function(e) {
                                ...
                                this.containers[p].containerCache.over = 1); else {
                                    for (n = 1e4, o = null, r = (c = d.floating || this._isFloating(this.currentItem)) ? "left" : "top", 
                                    a = c ? "width" : "height", u = c ? "pageX" : "pageY", s = this.items.length - 1; s >= 0; s--) t.contains(this.containers[p].element[0], this.items[s].item[0]) && this.items[s].item[0] !== this.currentItem[0] && (l = this.items[s].item.offset()[r], 
                                    h = !1, e[u] - l > this.items[s][a] / 2 && (h = !0), n > Math.abs(e[u] - l) && (n = Math.abs(e[u] - l), 
                            ...
                            _adjustValue: function(t) {
                                ...
                                t = parseFloat((t = e + i).toFixed(this._precision())), null !== s.max && t > s.max ? s.max : null !== s.min && s.min > t ? s.min : t;
                            },
                            _stop: function(t) {
                            ...
                            _processTabs: function() {
                                ...
                                this.tablist.on("mousedown" + this.eventNamespace, "> li", (function(e) {
                                    ...
                                    e._isLocal(s) ? (r = (n = s.hash).substring(1), o = e.element.find(e._sanitizeSelector(n))) : (n = "#" + (r = l.attr("aria-controls") || t({}).uniqueId()[0].id), 
                                    (o = e.element.find(n)).length || (o = e._createPanel(r)).insertAfter(e.panels[i - 1] || e.tablist), 
                            ...
                            _eventHandler: function(e) {
                                var i = this.options, s = this.active, n = t(e.currentTarget).closest("li"), o = n[0] === s[0], r = o && i.collapsible, a = r ? t() : this._getPanelForTab(n), l = s.length ? this._getPanelForTab(s) : t(), h = {
                                    oldTab: s,
                                    oldPanel: l,
                                    newTab: r ? t() : n,
                                    newPanel: a
                                };
                                e.preventDefault(), n.hasClass("ui-state-disabled") || n.hasClass("ui-tabs-loading") || this.running || o && !i.collapsible || !1 === this._trigger("beforeActivate", e, h) || (i.active = !r && this.tabs.index(n), 
                                this.active = o ? t() : n, this.xhr && this.xhr.abort(), l.length || a.length || t.error("jQuery UI Tabs: Mismatching fragment identifier."), 
                                a.length && this.load(this.tabs.index(n), e), this._toggle(e, h));
                            },
                            _toggle: function(e, i) {
                                ...
                                function n() {
                                    o._addClass(i.newTab.closest("li"), "ui-tabs-active", "ui-state-active"), r.length && o.options.show ? o._show(r, o.options.show, s) : (r.show(), 
                                    s());
                                }
                                ...
                                a.hide(), n()), a.attr("aria-hidden", "true"), i.oldTab.attr({
                                    "aria-selected": "false",
                                    "aria-expanded": "false"
                            ...
                            load: function(e, i) {
                                ...
                                var s = this, n = this.tabs.eq(e), o = n.find(".ui-tabs-anchor"), r = this._getPanelForTab(n), a = {
                                    ...
                                    "abort" === e && s.panels.stop(!1, !0), s._removeClass(n, "ui-tabs-loading"), r.removeAttr("aria-busy"), 
                                    t === s.xhr && delete s.xhr;
                                };
                                this._isLocal(o[0]) || (this.xhr = t.ajax(this._ajaxSettings(o, i, a)), this.xhr && "canceled" !== this.xhr.statusText && (this._addClass(n, "ui-tabs-loading"), 
                                r.attr("aria-busy", "true"), this.xhr.done((function(t, e, n) {
                                    setTimeout((function() {
                            ...
                            _open: function(e, i, s) {
                                ...
                                if (s) {
                                    ...
                                    r = (o = this._tooltip(i)).tooltip, this._addDescribedBy(i, r.attr("id")), r.find(".ui-tooltip-content").html(s), 
                                    this.liveRegion.children().hide(), (l = t("<div>").html(r.find(".ui-tooltip-content").html())).removeAttr("name").find("[name]").removeAttr("name"), 
                    ...
                    }, void 0 === (a = o.apply(e, [ s ])) || (t.exports = a);
                }
            }));
        }
    }, e = {};
    ...
    i.nmd = t => (t.paths = [], t.children || (t.children = []), t), i(7002);
})();